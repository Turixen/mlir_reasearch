...
module {
    ...
    func.func @mul_ds(%t : tensor<10x10xf64, #CSR>, %s : tensor<10x10xf64>, %out : tensor<10x10xf64>) -> tensor<10x10xf64> {
    %0 = linalg.generic #trait_mul_ds
        ins(%arga, %argb: tensor<10x10xf64, #CSR>, tensor<10x10xf64>)
        outs(%argx: tensor<10x10xf64>) {
    ...
    func.func @main() -> i64 {
        ...
        %result_matrix = call @mul_ds(%t_sparse, %s, %c) :
        ...
        %element_f64 = tensor.extract %result_matrix[%c2, %c2] : tensor<10x10xf64>
