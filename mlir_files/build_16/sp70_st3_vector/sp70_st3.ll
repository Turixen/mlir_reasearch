...
@__constant_10x10xf64 = private constant [10 x [10 x double]] [[10 x double] [double 0x40210DBDECD7FC5C, double 0x4019D83439E533F6, double 0x40131E1E7145A0DA, double 0x4004A9C244D50710, double 0x402358C5B8E8887E, double 0x3FD640EE4999C710, double 0x4022EE144FE5D08F, double 0x401A75AACDDFA618, double 0x4012842DE881F706, double 0x3FEF3C85B0356902], [10 x double] [double 0x3FE7A4848E14D8F8, double 0x3FDCBC90BC324238, double 0x3FFB3A77FC694C94, double 0x401D3185BE9418D0, double 0x400E897DA49F17A7, double 0x40116E6F18FC0E8A, double 0x4000FAEEDE9F4551, double 0x3FD672BFCF834D58, double 0x4007EFC244530373, double 0x3FF94B97C8DBEBC3], [10 x double] [double 0x40031FEEB64CA8E7, double 0x4010E76BC45DD7AD, double 0x3FFB46643A98F436, double 0x4022E090EFB6E415, double 0x400FF09FAB82DB05, double 0x40150F9C3F215442, double 0x40219412B6462E16, double 0x4010FC0A6484A4D6, double 0x400AA33C1D712E1E, double 0x4023C68B3E3D1DFF], [10 x double] [double 0x3FF43B4F73135E4F, double 0x4020D159E02DD410, double 0x3FF33E5346E80BD5, double 0x401699C6AFB4B51E, double 0x4013B6D4C8E3E703, double 0x402027759E96E6F2, double 0x401FDA7EB330F5D5, double 0x40228C457ECE7B37, double 0x40106810FB483F80, double 0x40109EEBBB795719], [10 x double] [double 0x3FF576246A1B40F8, double 0x401F18B1C67E3C30, double 0x400ED90ABEB8C23C, double 0x4001B5B03EAF0EB9, double 0x3FE4776E74755B2A, double 0x40182413C87DB46E, double 0x400E0233FADA86C3, double 0x3FF678F673E13D65, double 0x401661CF9FB280F5, double 0x40067D0EE910BB3A], [10 x double] [double 0x40221D73ECFABE08, double 0x401B5B59E902D2C2, double 0x4017E99AD972CE76, double 0x3FFBA079946A6A4D, double 0x402243E06BE82BCC, double 0x4002E32E12203A8A, double 0x40223B35E8782F5F, double 0x400B932C35879F08, double 0x401509E9D1C659F0, double 0x4020DE848C570A8E], [10 x double] [double 0x3FE1554869D58258, double 0x3FF9D79C68734D9E, double 0x401CA327DD316B00, double 0x400CA5B1EF7790BA, double 0x400C2F857B09ED5A, double 0x401A626F92A7A4A8, double 0x400BE375C771BF29, double 0x40076BCEF25B1889, double 0x4015C2F4DA2AC0B8, double 0x40087139918809F1], [10 x double] [double 0x40225E52FCD7262A, double 0x40112D425FEA5190, double 0x4013672A3B025EC0, double 0x40233774A3AD1FC1, double 0x3FD6E61851ED31C0, double 0x3FF7240DBA7C26DC, double 0x3FED7E08A846B6AC, double 0x4016CCE07917B778, double 0x400BD95397C20E56, double 0x400604BB02685EBB], [10 x double] [double 0x401BA121C6AC0E47, double 0x4021BC8ADBE1C7AD, double 0x401221AE67982D7A, double 0x40208991E30C56C4, double 0x4014E5F7A20979BA, double 0x4014BB5A32A81D64, double 0x4018A81EB8BC023E, double 0x40172C8238D96919, double 0x3FE7E24697E506C8, double 0x40228A08EDBD9320], [10 x double] [double 0x400967685B4CFAE4, double 0x4023551C77AE179E, double 0x3FA223DA470F8280, double 0x3FFBF8E95D7BF0AB, double 0x4005376680191E4C, double 0x4020D5E15122895F, double 0x3FC730C04896E010, double 0x3FF5416B5F0AC27B, double 0x3FC37865C44A72B0, double 0x3FF0C513F3A94AD4]], align 64
@__constant_30xindex = private constant [30 x i64] [i64 0, i64 3, i64 6, i64 9, i64 1, i64 2, i64 9, i64 0, i64 8, i64 0, i64 1, i64 3, i64 6, i64 9, i64 1, i64 7, i64 6, i64 0, i64 3, i64 6, i64 9, i64 1, i64 2, i64 5, i64 0, i64 2, i64 3, i64 5, i64 6, i64 9], align 64
@__constant_11xindex = private constant [11 x i64] [i64 0, i64 4, i64 7, i64 9, i64 14, i64 16, i64 17, i64 21, i64 23, i64 24, i64 30], align 64
@__constant_30xf64 = private constant [30 x double] [double 0x4022C6F3D3A1D324, double 0x40171EEBB341E14C, double 0x401E9B96F21F6CAD, double 3.516610e-01, double 6.054780e+00, double 4.441670e+00, double 5.472360e+00, double 0x400B35DB3397DD01, double 0x4023ED18B0D0EDC4, double 0x400076D0917D6B66, double 0x3FFF745F17BD8BE7, double 0x4003C535C9E6687F, double 0x4017DF262888B546, double 0x4001FD15F02C4D66, double 0x4015044178705426, double 0x4022D92B3CC4AC6D, double 0x401F28C7E28240B8, double 2.402090e+00, double 0x40101EACC92146A2, double 1.748730e+00, double 0x40191C3BD5992429, double 0x401736EE30CAA327, double 0x4023234EFCBD5561, double 2.650650e+00, double 0x401E8E45C358AFC4, double 0x4014D1DB0142F61F, double 0x4011B0B135979182, double 0x40147D07852F7F4A, double 0x40219CBAF965B20C, double 0x400281EC4E7253DA], align 64
