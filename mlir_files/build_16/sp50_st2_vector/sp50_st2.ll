...
@__constant_10x10xf64 = private constant [10 x [10 x double]] [[10 x double] [double 0x40125495E6F3896D, double 0x402026656BEE6FD0, double 0x401D7D5127951E62, double 0x4001F068EFE610C0, double 0x401A7876785CF3B5, double 0x400CC1C364C795B2, double 0x40195DEC36D261AF, double 0x3FEA2BF12457EB84, double 0x402391A716C8FE53, double 0x40189711E609DE74], [10 x double] [double 0x4004CDA5933A7E36, double 0x4021228BDB19D590, double 0x40113655FD1FCA0A, double 0x401D6B126ABBDA45, double 0x4014B50CCFA9C28A, double 0x3FD29A009ED8E7E4, double 0x400C04C081364638, double 0x402284467422A61A, double 0x3FF42D78EE529E07, double 0x4006E7B3EE82BC00], [10 x double] [double 0x3FFF2D872192D5B6, double 0x402273C92FD3EED5, double 0x4007464587B33024, double 0x4022ACDDC95E2CDD, double 0x401B8F8046F9BE95, double 0x40055833544C84A8, double 0x4013B33BEF2152EC, double 0x400E4C89F870BD9C, double 0x4013855EB1EC3941, double 0x40124001FF39E5FC], [10 x double] [double 0x40191877AFB49984, double 0x4021CF177E2FCADE, double 0x3FD79279DCBCF548, double 0x4021E30F716D9584, double 0x3FE7DAEFCC289B1A, double 0x3FFD7968EAF5549E, double 0x400CA21A73737A3E, double 0x4023DF69B682F3D1, double 0x4021320C75433659, double 0x4018833D69CA6C1E], [10 x double] [double 0x401ECDC127F85368, double 0x40098A9954CBB8E2, double 0x4021C78916E35EF5, double 0x402245AD94B65034, double 0x40163651CB1F6FB7, double 0x4003CC85B9D4AFB4, double 0x400A75E24D2A5F78, double 0x401EBAE9F80BE705, double 0x400BF7F3DD217504, double 0x4003DE1B043F74EC], [10 x double] [double 0x4017DF8E8176C988, double 0x401283B05DFDCD1A, double 0x3FBCB0EE7D55C7E0, double 0x400C860A99240C7C, double 0x3FF6474949FB9588, double 0x400F19B2627A67F3, double 0x401B86DE02512CBF, double 0x401E9E2DC4864449, double 0x3FF1549F1478BEAA, double 0x3FF8BF7025276CF4], [10 x double] [double 0x40117657368B23A1, double 0x401034CE5AB71B25, double 0x40065E702CA6EFA0, double 0x402122188BA8045F, double 0x40025B53728A3E72, double 0x401CA1324F7EF430, double 0x4010A7FF8AB09117, double 0x401B2DD09A270A4A, double 0x40231EDEB773FFE3, double 0x4007FC90D25BEB14], [10 x double] [double 0x40163BC408CA2C98, double 0x4023DC8B6B899D46, double 0x401782C22FC4E2BD, double 0x401BCAE0878CBF23, double 0x4022518F534FA7A2, double 0x40058392534E49F3, double 0x400F872F19933868, double 0x40192E210E879BAB, double 0x4019D800605E72CA, double 0x4012DBFAB94A5F0F], [10 x double] [double 0x400E0687F6D46A7D, double 0x4010DCF4BE023EDA, double 0x400A52F852A0588E, double 0x4011FF2A01931E90, double 0x4020F3D68AE64DC2, double 0x40125984DC30FC18, double 0x400BC41472ACE7B9, double 0x401B0536244114AA, double 0x40222F0F05F7DAD8, double 0x40077DADEF1378F8], [10 x double] [double 0x4023F173373CB3AF, double 0x3FFA4A9795108B3C, double 0x4009829B1286731C, double 0x4002D9A598E27436, double 0x4015C6789459EEA6, double 0x3FF22F79A2D5FB3F, double 0x3FF8010F52A25777, double 0x401FCF61B2401151, double 0x3FF2B0C4055AFB45, double 0x3FFDA299A64F8A3A]], align 64
@__constant_50xindex = private constant [50 x i64] [i64 0, i64 2, i64 4, i64 6, i64 8, i64 0, i64 1, i64 2, i64 3, i64 7, i64 8, i64 9, i64 0, i64 1, i64 2, i64 4, i64 6, i64 8, i64 0, i64 6, i64 7, i64 8, i64 9, i64 0, i64 2, i64 4, i64 5, i64 6, i64 7, i64 8, i64 1, i64 2, i64 4, i64 7, i64 0, i64 2, i64 3, i64 4, i64 5, i64 6, i64 8, i64 1, i64 0, i64 2, i64 4, i64 6, i64 8, i64 0, i64 6, i64 8], align 64
@__constant_11xindex = private constant [11 x i64] [i64 0, i64 5, i64 12, i64 18, i64 23, i64 30, i64 34, i64 41, i64 42, i64 47, i64 50], align 64
@__constant_50xf64 = private constant [50 x double] [double 0x40143549731098D4, double 0x4023468F4B61FE22, double 0x401A517763E4ABE7, double 5.624140e-01, double 2.017930e-01, double 3.907510e+00, double 8.642910e-01, double 0x3FFEE581CF7878B8, double 0x3FFB5BD8383AD9F1, double 0x3FF1724A6A875D57, double 0x4020304F2AE07E5A, double 0x401D3EA7CE0FC2EC, double 0x4020AAB3CC4AC6CE, double 0x4020347D1BB4916D, double 3.688470e+00, double 0x4020458904F6DFC6, double 8.570330e+00, double 0x40114BDDFC9FF92F, double 0x4023E62281344806, double 0x4007BBD9CAE21102, double 0x40022AE3A3A8E714, double 1.650870e-01, double 0x4019978897E99631, double 0x40173A715831F03D, double 2.801870e-01, double 0x4016EDF3300DE4C5, double 8.147140e-01, double 0x400F4D740C4156E2, double 0x4007FAB0856E696A, double 0x402360943E100608, double 0x3FFD01BB8C32A8CA, double 0x4003A11A975AFAF8, double 0x3FE7F53C579F2346, double 2.574780e-01, double 0x4019861240746456, double 0x400EDE3C968943E1, double 0x4023F2C322291FB4, double 7.775020e+00, double 0x400BD94317ACC4F0, double 0x4013F7C73EEE5259, double 0x4023C737542A23C0, double 0x4012B2E1693C03BC, double 0x3FF3EFA7221858BC, double 2.697710e+00, double 0x40193C18B502ABAC, double 0x4022BD29563A9F38, double 4.448670e-01, double 0x4004A16D6DC1A47B, double 0x400D5671AC14C661, double 0x401B92DB61BB05FB], align 64
