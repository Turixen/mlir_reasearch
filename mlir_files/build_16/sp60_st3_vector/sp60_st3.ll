...
@__constant_10x10xf64 = private constant [10 x [10 x double]] [[10 x double] [double 0x3FE2D8E655B9A38A, double 0x40012FBA46768EA5, double 0x4019D9926F4FD5C8, double 0x4018914AB4DE7B56, double 0x40189706D82FB838, double 0x400C1B36252B5A51, double 0x401FC8753D644A9E, double 0x40044B7A8C339240, double 0x401602A29FC34A19, double 0x4002AF42CA7F80AE], [10 x double] [double 0x3FE7127F6E3871B2, double 0x402363D60D28FB01, double 0x3FC523357D0D2C68, double 0x4016CB8834CE78F5, double 0x40160D364136F7D1, double 0x4010219FD1330165, double 0x4022D2B94B3C4FAE, double 0x4011B9FE269EB504, double 0x4011270DDC75D39C, double 0x3FF32F3C405C4E5F], [10 x double] [double 0x401EA0B530C60708, double 0x3FD4E023F9B9BFC4, double 0x40196DE0B80ED8CE, double 0x4001BA7DA35DF817, double 0x4003E3A7CD46F1FB, double 0x401557BB4AC3F429, double 0x40149B85B1875630, double 0x40143C8EE263FF6E, double 0x400724E47CBCBBB0, double 0x4022F07811334B00], [10 x double] [double 0x401244FB99A8849B, double 0x4016291D63021F37, double 0x3FF074ACB05BB783, double 0x400793F537B9BDC9, double 0x40203E1EF04E6F45, double 0x4004722BB8461D37, double 0x400D51884002A02E, double 0x40136165BC0931DF, double 0x400676E699FCED4E, double 0x402264F011863E32], [10 x double] [double 0x401D587A0EE32A45, double 0x402341AE365034CC, double 0x4017F0B8E5A06782, double 0x401E0ADFDDE2319A, double 0x400489ACD3C28AAA, double 0x4012FD4B75779373, double 0x401DE646CAF350A4, double 0x3FF1D50B41045CFD, double 0x401FE29E9C723E4D, double 0x401509D09CB6B6FE], [10 x double] [double 0x4020C382777881B9, double 0x401850A517A89904, double 0x4021E702D111D906, double 0x3FC1FF9833CA8A78, double 0x4012E794B95EF6B3, double 0x40221133C1B6F6C4, double 0x3FEB0542421F1D38, double 0x4021DCBBE5371D50, double 0x4019F6F82274D8D8, double 0x40199B985D147C60], [10 x double] [double 0x4016C87B40703F01, double 0x4008BF31D7A3E392, double 0x3FDB39BAB53793AC, double 0x40041611CB6BDB61, double 0x40180EBE587DE882, double 0x40214AE5ED948CCC, double 0x40153F9C70B65B1F, double 0x401894A0EA6A6102, double 0x402332A4F16EEB00, double 0x402084782806860B], [10 x double] [double 0x401E8F162E2B0518, double 0x4020B0B184A3E9E2, double 0x40190632FB573CE3, double 0x400D2BFC6B4A9245, double 0x4002F263C721958A, double 0x4022556395F5FD46, double 0x400DBB65500296D3, double 0x40061814C65C8231, double 0x401FAE538839B03F, double 0x4020082E5907A1BC], [10 x double] [double 0x4020882698F1481B, double 0x40108899F651D24F, double 0x401A154FBFEDBCFA, double 0x400DF5EE32CE7212, double 0x40162089F143B150, double 0x4013AAC8785E6A29, double 0x4018961C72FA8430, double 0x4023F7D1DA4E9BD0, double 0x4005E7C4954BE944, double 0x3FFDE4280FD12025], [10 x double] [double 0x3FF8033BC0C88B12, double 0x4001C79A7ED10E5E, double 0x40029FABE9BA7F68, double 0x4022504920A26E03, double 0x401F3542D0FF4A89, double 0x401923D9E08286BD, double 0x4003AAB9DEDFECEB, double 0x40220D4AD6D2C0DA, double 0x401AC74490D5C62F, double 0x4000EA4FB346B198]], align 64
@__constant_40xindex = private constant [40 x i64] [i64 0, i64 1, i64 3, i64 5, i64 6, i64 9, i64 0, i64 3, i64 1, i64 2, i64 4, i64 9, i64 0, i64 1, i64 2, i64 3, i64 6, i64 7, i64 8, i64 9, i64 1, i64 2, i64 9, i64 1, i64 0, i64 3, i64 6, i64 9, i64 0, i64 3, i64 5, i64 8, i64 0, i64 0, i64 1, i64 3, i64 4, i64 5, i64 6, i64 9], align 64
@__constant_11xindex = private constant [11 x i64] [i64 0, i64 6, i64 8, i64 12, i64 20, i64 23, i64 24, i64 28, i64 32, i64 33, i64 40], align 64
@__constant_40xf64 = private constant [40 x double] [double 0x401108BB906466B2, double 6.203650e-01, double 0x40188387160956C1, double 0x3FF0239A38FBCA10, double 0x3FF934B407032980, double 0x3FFF706705C896DD, double 0x3FFBB11A543F1C76, double 0x401FA2999567DBB1, double 0x401F040789613D32, double 0x4015AF3F961804DA, double 0x4011D4A0A0F4D7AE, double 0x401E0801711947D0, double 0x4023064883FD5022, double 8.418360e-01, double 0x40158D5B24E9C454, double 0x40188ACC92146A1A, double 0x4008AE71CDA2B5A2, double 0x40195E6D15AD106F, double 0x401C14E2F37FBEFD, double 0x4003E8EDE54B48D4, double 0x401761D53CDDD6E0, double 4.665650e+00, double 5.142510e-01, double 0x4010FE18AC9F2FDC, double 0x4002FC9BC7714339, double 0x40204D8E64B23140, double 0x4022C0027D88C1DB, double 0x40067818C5C9A34D, double 0x4015C07AAEF2C732, double 0x40049338F7985272, double 0x4018004534BD76EE, double 0x3FF528FE260B2C84, double 0x400189C4545846E9, double 0x401D2C1615EBFA8F, double 0x401B1F7985271BCE, double 0x400C5005814940BC, double 0x4003AE74F2F123C4, double 0x401A552502EEC7C9, double 0x4008E2C1B10FD7E4, double 0x401E40AE10492360], align 64
