...
@__constant_10x10xf64 = private constant [10 x [10 x double]] [[10 x double] [double 0x402218B6E2D67465, double 0x3FFA7FFC3B7631E0, double 0x401B88122440E721, double 0x4020BBC58A73C480, double 0x4016123983FBAD5E, double 0x4007B1960E5A5A18, double 0x4016E35BED92DADA, double 0x401542A1DBC40E6D, double 0x3FE777E9DFECB5F0, double 0x40187E1014D4883E], [10 x double] [double 0x4003C3462793E710, double 0x401E42F4129AD06A, double 0x400FBE0BF5070A04, double 0x400BB88CCEC8C038, double 0x4020FB5AAD741754, double 0x4020E610E6700D1A, double 0x400A62D7DD659FD0, double 0x3FB37CB0949037E0, double 0x40135FDA843E7F66, double 0x3FF0BED163DD0136], [10 x double] [double 0x3FEE6DAA06530D68, double 0x4020FAD4FC92AC97, double 0x40121C1648140804, double 0x4019E8B7FA97169D, double 0x40185D3398039CE6, double 0x401CB276A8363C4B, double 0x401BB5E24D3957C4, double 0x402152AF66E80063, double 0x3FF96511F0E916AC, double 0x40179ECD54C0EDED], [10 x double] [double 0x40205346BAEC1268, double 0x4020757259083392, double 0x40023AFFB3F3DA4C, double 0x4006D3DEC59B5708, double 0x401A4543012E2EF8, double 0x401C60969AD069F4, double 0x402117153A7F3426, double 0x40077352A4FA380A, double 0x4013B6C7962EDDD2, double 0x4015B8F430B65249], [10 x double] [double 0x401D6F0A2865572A, double 0x40127C1171FE3882, double 0x4021D4000E1BE3D3, double 0x4017C228C103B48D, double 0x400D06A6EE90C81B, double 0x401AD2B16722C0C7, double 0x401DBDF7F732F7CC, double 0x4019E70922B24DDE, double 0x401A44FF0113C70E, double 0x40238A32FB71F5E8], [10 x double] [double 0x4010F5FDA927E103, double 0x4018272AFB51B004, double 0x4000BEE5D5642D18, double 0x4008753F6396EFE4, double 0x4016011510D340E5, double 0x40191A02854240B3, double 0x3FF49FDA0AB88C0E, double 0x4017B3D0B5C1D81D, double 0x3F8A7A0E46034B00, double 0x400A3812B6BA0F3E], [10 x double] [double 0x401526100BDE4A21, double 0x401065788E5CEF0E, double 0x4013A7AB5EE0AEE1, double 0x4009B37CD10F0C51, double 0x40116CC8998E11AA, double 0x3FE42570C9482EDE, double 0x40232D6E026248FF, double 0x4006DEBCA96674E7, double 0x400297A465CA935A, double 0x400BC167FDC23890], [10 x double] [double 0x4013A62B03730E83, double 0x401EC145FF2D90F9, double 0x3FD24EA6C6D6A574, double 0x3FF76140A5368BE9, double 0x400732DAF226D457, double 0x3FF25B05822EEB64, double 0x4005D46265B45172, double 0x4008DAF7B86B0034, double 0x401850190E50063A, double 0x401D8847B2A73BAB], [10 x double] [double 0x3FF44973293BC01E, double 0x3FE11DC3DE939B00, double 0x3FE10EDD5038B11E, double 0x402387C4A8EB06C5, double 0x4002F07175869D36, double 0x4010784E2E3622AB, double 0x400FF8629E5E600A, double 0x4017A4DB2A13319E, double 0x402359F3EBD84701, double 0x401AE6773FAD7FC2], [10 x double] [double 0x401D2C17323AE500, double 0x3FF846C745134550, double 0x3FC7A499F1E14A28, double 0x4015F9248CE9F0DE, double 0x3FEB96E48955E266, double 0x3FF0F7B7DF7F6AC1, double 0x401634D119DDCFD4, double 0x3FF1CABF9DAF0A35, double 0x3FF2F82B50B7CD9E, double 0x4023ADC30B4D47E3]], align 64
@__constant_35xindex = private constant [35 x i64] [i64 0, i64 2, i64 3, i64 4, i64 5, i64 6, i64 9, i64 2, i64 6, i64 9, i64 1, i64 9, i64 0, i64 3, i64 4, i64 5, i64 6, i64 7, i64 9, i64 1, i64 1, i64 3, i64 5, i64 6, i64 0, i64 3, i64 6, i64 9, i64 7, i64 3, i64 7, i64 0, i64 3, i64 6, i64 9], align 64
@__constant_11xindex = private constant [11 x i64] [i64 0, i64 7, i64 10, i64 12, i64 19, i64 20, i64 24, i64 28, i64 29, i64 31, i64 35], align 64
@__constant_35xf64 = private constant [35 x double] [double 0x4020C0A569B17482, double 0x401D6D1958969A0B, double 0x4015F570C564F97F, double 4.129680e-01, double 0x4020D6703AFB7E91, double 0x400CAF8D716D2AA6, double 0x400812D44DCA8E2E, double 9.910360e+00, double 0x4018082F944241C4, double 0x40052BA1F4B1EE24, double 0x3FF0F7E80389F83C, double 0x4007AA2EC28B2A6B, double 0x400B25F6BA0620AB, double 0x40104FEDE97D06BC, double 0x40166E3E29307AF2, double 0x402267A95C853C15, double 0x402063838C111ADA, double 0x4007380B242070B9, double 0x4021AD8C08B75EA6, double 0x3FF5301A79FEC99F, double 0x4002062ED352220C, double 0x3FFEE0BD44998D04, double 0x400A9418D6909AED, double 0x4004DB9389B52008, double 0x402150BA40D90E24, double 0x40032CD63CB81733, double 1.569780e+00, double 0x40222A641B328B6E, double 0x40142064ECE9A2C6, double 0x4012C67125DD095B, double 0x401D3093D9663843, double 0x3FF0606D938151A4, double 0x401F5F8EC0F88334, double 7.360770e+00, double 0x4007F796BFCA85CB], align 64
