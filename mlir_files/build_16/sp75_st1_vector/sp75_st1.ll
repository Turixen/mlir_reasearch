...
@__constant_10x10xf64 = private constant [10 x [10 x double]] [[10 x double] [double 0x40097B58EA5AEF2E, double 0x400C45EF7DCD2FCF, double 0x400229EA6F3C6B7C, double 0x4020D3438D969ACF, double 0x3FF5CDFC83E502CD, double 0x4023043A4C03F6A0, double 0x3FF6DE93B1C32708, double 0x40155041B2981BDA, double 0x401A6229D7AE3146, double 0x402124A9FA39D001], [10 x double] [double 0x4021DE6D673BA7A0, double 0x401470847F56CAE3, double 0x40160C1BC45C8E3A, double 0x401269B044224854, double 0x40233216ABDA32B2, double 0x4022A4C6B7F5F657, double 0x4001B0F45BAAC606, double 0x4005DC243FAB8001, double 0x4023E269482D1869, double 0x4011DC268BEDCDAE], [10 x double] [double 0x40103315E78A2FE3, double 0x4012CFC659275AAA, double 0x401655DEC6968D53, double 0x400B8F7C663AEAE8, double 0x400C80282527D9D3, double 0x401C84EE0B2D07CD, double 0x402273DFC7152F65, double 0x4000BF395F0DBE08, double 0x4022103DB429D2DF, double 0x401238690421FBC1], [10 x double] [double 0x40131D2018E202C4, double 0x401A708592052B12, double 0x3FA87FF2E6E55260, double 0x4007CF36CA8ABE65, double 0x40228B999F6E898C, double 0x4004035999E688A9, double 0x3FF4EAF162C3F4D5, double 0x4004AF2F51A620A9, double 0x4020E586EBEEC01E, double 0x3FEC6A5C8506BB6C], [10 x double] [double 0x40163A501FE87F05, double 0x401F1E8870B020FE, double 0x4013D9D744D24F1A, double 0x401891F2D288D663, double 0x4012FD86D6613C2B, double 0x400C829D38CFEA7E, double 0x401D5D5AF7E8745A, double 0x3FF1AB748C7089E8, double 0x4023655F22C270B9, double 0x401148295D0045CF], [10 x double] [double 0x3FFA5116A0778AF9, double 0x401B59D04BD60FC2, double 0x4012C055CECC0F59, double 0x4005B352211410A2, double 0x4011F27A3BEB136B, double 0x40173C68291623D6, double 0x3FF9D4E9C04DE278, double 0x3FD4BDA2426483E8, double 0x3FE1D9447317E164, double 0x40131C02C2CEB920], [10 x double] [double 0x4021EF362F9240C4, double 0x3FCC97B4FAEB49A8, double 0x401E722492025848, double 0x4019ADE10C366FA6, double 0x3FE4E2CF675833A0, double 0x401300B387EB9A4E, double 0x4012BCFB061B7640, double 0x4020A438417A6FD1, double 0x40038C09008309AE, double 0x4008284DDD96FB46], [10 x double] [double 0x3FEBCC10CB102458, double 0x4012CA291E759DAF, double 0x4011BEAEA35B2264, double 0x4020CF96F8B12A2A, double 0x3FD9BD2A59E3AEA4, double 0x401B62535B8EB332, double 0x3FF01A6E5C5429B5, double 0x4011E15570E89338, double 0x401E9F29CBB291BD, double 0x401C1078C3A405F0], [10 x double] [double 0x40158A29DB1CE285, double 0x3FF2DFBC32BD7582, double 0x4023B407CCE768A0, double 0x3FE1AD5D9FB1ED68, double 0x4016A4BC5D0C545C, double 0x3FD138FB18869A68, double 0x4013032E7E0DFD84, double 0x3FE889EC3E6C2272, double 0x4012456B003CA608, double 0x401CBD456CE59071], [10 x double] [double 0x402382A52C249B93, double 0x401944B7AD8EB78A, double 0x401B99B169CAE1FB, double 0x40208209FBE9FA1C, double 0x4002B43819561E6C, double 0x40220E67C11620A0, double 0x401713D0C40B0E32, double 0x400E167AF647C192, double 0x3FFD5A3A3D93A947, double 0x3FF99217BC6E2BDC]], align 64
@__constant_25xindex = private constant [25 x i64] [i64 6, i64 9, i64 4, i64 6, i64 9, i64 0, i64 8, i64 0, i64 3, i64 7, i64 0, i64 9, i64 5, i64 3, i64 1, i64 2, i64 4, i64 5, i64 6, i64 7, i64 8, i64 9, i64 2, i64 5, i64 7], align 64
@__constant_11xindex = private constant [11 x i64] [i64 0, i64 2, i64 5, i64 7, i64 10, i64 12, i64 13, i64 14, i64 16, i64 22, i64 25], align 64
@__constant_25xf64 = private constant [25 x double] [double 0x401B2181E03F7058, double 3.159000e-01, double 0x400A1EE5EEDCC20D, double 0x400C5CD91EEAA6D2, double 0x4007B526D8B1DD5D, double 8.115620e-01, double 0x401ED35F80991794, double 0x3FF1F778DD616F87, double 0x4018FA604E1E7104, double 0x401F5CE8101F31F4, double 2.852970e+00, double 0x40221E138FFFBCE4, double 0x4019BB5E529BAE47, double 0x3FF5AD31FCD24E16, double 0x40086675147F1306, double 0x4015E8C436FC1590, double 0x40211D0D6B228DCA, double 8.144190e+00, double 0x3FFD2FB6DCA07F67, double 0x4018FB4E54F7A919, double 0x4011DD60A6330510, double 0x4017934C1A8AC5C1, double 0x401A467C6B8B6955, double 0x4022F4195CC857F3, double 0x3FF40B60F1B25F63], align 64
