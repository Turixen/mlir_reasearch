module {
  ...
  llvm.mlir.global private constant @__constant_9xindex(dense<[1, 7, 8, 1, 2, 8, 3, 1, 4]> : tensor<9xindex>) {addr_space = 0 : i32, alignment = 64 : i64} : !llvm.array<9 x i64>
  llvm.mlir.global private constant @__constant_11xindex(dense<[0, 0, 2, 2, 3, 5, 6, 6, 7, 9, 9]> : tensor<11xindex>) {addr_space = 0 : i32, alignment = 64 : i64} : !llvm.array<11 x i64>
  llvm.mlir.global private constant @__constant_9xf64(dense<[4.2308349999999999, 5.7620380000000004, 7.7919809999999998, 1.3108329999999999, 7.2131679999999996, 1.146600e-01, 3.7433489999999998, 4.5144320000000002, 5.3645060000000004]> : tensor<9xf64>) {addr_space = 0 : i32, alignment = 64 : i64} : !llvm.array<9 x f64>
  llvm.mlir.global private constant @__constant_10x10xf64(dense<[[0.74739859258172947, 3.3726963971801105, 0.21443876747050172, 3.7125564651718834, 9.4189694927547833, 5.6180430260083805, 7.3043801661806036, 8.8912547687526349, 0.055208936336775816, 8.9445736623063414], [9.7352957892223024, 6.1655537724341416, 9.6372883007575254, 8.8112664140515999, 3.5485949099175507, 7.7954444354404888, 2.506132464310574, 7.3961118798342573, 8.7991838428781861, 7.9450235242624822], [8.5203752067975085, 8.5488679560523888, 4.230554800056332, 4.3037248238689116, 3.8254594684574119, 4.5957631516490611, 6.5320016733184749, 9.6055676798055333, 4.4610296180464415, 7.9475169595231616], [8.2133946143569823, 9.6878183046751402, 4.4678060677799634, 6.4988469687957648, 3.9341749620483899, 4.9084326379831653, 8.0940502297559842, 9.8252818812218318, 3.3571305342676983, 4.4732519409224576], [8.3708775488882718, 4.6268138843478459, 8.9930668037845418, 1.8732246486513204, 1.6670452903312083, 0.30083970810967364, 8.8397950244956665, 3.1005805107127706, 3.5866618795578784, 5.6468678293476078], [9.024974276181057, 6.4746599860463334, 7.4977301987778401, 9.8536649398471496, 4.2930818006022093, 6.8801683222116941, 0.019928510432148938, 7.2947366915342924, 3.9886947780273516, 3.2603945036032336], [1.4714037759812859, 4.3459087932310778, 9.6870091368747921, 5.2765870061224982, 9.8792943794112844, 4.3258098072246671, 5.5016754209854, 0.30606449185092588, 9.4324248067992098, 1.9919321280485436], [2.5079320061420574, 2.8963589241486911, 8.1658413580330329, 2.4857238565795936, 3.7071374824842351, 8.5886751535678769, 2.7938640615277031, 6.9013415293950491, 9.7197914713951902, 0.97400716879349147], [1.6262337238244717, 3.1825476863096593, 4.8377704679832032, 5.4366685442388327, 1.0345592177830765, 6.1012673694701061, 8.0040961919816329, 3.2910376822200806, 6.8452309105858209, 9.1674667250110104], [5.3736857436167229, 2.4120223679297448, 0.73281189529439739, 8.5097429190446778, 1.1270700058993666, 3.0081995464878473, 1.5841166226406611, 1.0435777170977412, 8.8520053713806046, 7.1012305666132436]]> : tensor<10x10xf64>) {addr_space = 0 : i32, alignment = 64 : i64} : !llvm.array<10 x array<10 x f64>>
  ...
  llvm.func @assemble_sparse() -> !llvm.struct<(struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)>, struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)>, struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)>, struct<(array<2 x i64>, array<3 x i64>)>)> {
    %0 = llvm.mlir.addressof @__constant_9xindex : !llvm.ptr
    ...
    %6 = llvm.mlir.addressof @__constant_9xf64 : !llvm.ptr
    ...
    %15 = llvm.getelementptr %6[0, 0] : (!llvm.ptr) -> !llvm.ptr, !llvm.array<9 x f64>
    ...
    %29 = llvm.getelementptr %0[0, 0] : (!llvm.ptr) -> !llvm.ptr, !llvm.array<9 x i64>
