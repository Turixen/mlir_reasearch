...
@__constant_10x10xf64 = private constant [10 x [10 x double]] [[10 x double] [double 0x4023D7EF012ED892, double 0x4020CEA1CCCD9E88, double 0x3FF341575BBE4982, double 0x401D5D1C64E867CC, double 0x3FCE50E97001E708, double 0x4022CBF5BCCC70BE, double 0x401B8C3486AD21FC, double 0x401540F3A1D477AE, double 0x40093DC104F86866, double 0x40174F7DE98C846A], [10 x double] [double 0x401A74ABF80D6CE4, double 0x401870D1FEBCE573, double 0x3FC1750CD7264700, double 0x4010FC1DCE3693C0, double 0x400333002A9B8B88, double 0x40058EF77B7321DE, double 0x3FFC8EA0E6D4B4C1, double 0x401369B1233FC498, double 0x401F1479A60F27A8, double 0x3FFD1A12F5E1C037], [10 x double] [double 0x4022DDCDA288D81B, double 0x3FF5E93513EACBA2, double 0x4019EE20C32C6753, double 0x4021D6E268233920, double 0x4008030BA0AB93EF, double 0x400D30DDA7D7D05C, double 0x40220D590A92B626, double 0x401E8B45BC7638C6, double 0x402362ED44B42472, double 0x40204C7747ACB0DE], [10 x double] [double 0x40215BA7AD41E07D, double 0x3FE692548881A846, double 0x40227B22BEE12C73, double 0x40220569FE1E1090, double 0x4023930FA99B7FC5, double 0x40093C73E9BD4764, double 0x40028CCE2B5FB04D, double 0x4006C97242220F80, double 0x402174EF70DD9A5A, double 0x40182232482C7AB8], [10 x double] [double 0x4010615F8F90D792, double 0x400344B7FA18C905, double 0x4004CCB64AC79F9D, double 0x40214A96258E8B53, double 0x40022E455ADDB908, double 0x401F40892BFCB334, double 0x4019302034AA51EA, double 0x401CE911C6513065, double 0x4020EA0757587650, double 0x3FE78568560A4CE4], [10 x double] [double 0x3FDA0344DDD2618C, double 0x40026E04FEC03C34, double 0x3FFF9DEB7B074E90, double 0x4018A117286F0F9B, double 0x401FF572CE33E532, double 0x40032368887821C1, double 0x40117F4BF4AB429A, double 0x400FAE0F19BD169C, double 0x401A01BE827D9358, double 0x4018AB8A65529B55], [10 x double] [double 0x401D770CF4947186, double 0x4021F7F86FFCE962, double 0x40178E1C14CA9810, double 0x401FF56DC61ACDAE, double 0x3FEE42AAD1333042, double 0x4010C3F4F904999F, double 0x401ECED30A843F95, double 0x40185CAF494DD732, double 0x4015A0AA9C2ABBB2, double 0x4016F8DAECE862A0], [10 x double] [double 0x3FC2A6D8F499E2C0, double 0x401C11257AB37BA9, double 0x3FFB0DCEDEF3310F, double 0x4021584941B5584C, double 0x40202114674EAD39, double 0x401C6CEBADFD24BF, double 0x3FDF5F87924205E8, double 0x402123F09BF4BC54, double 0x4020EEC7D4050675, double 0x40203BA2A0195729], [10 x double] [double 0x401177AE0DC38C85, double 0x401BB66D3E819F06, double 0x400A1AF2F9D42927, double 0x4012FA5A83A3207C, double 0x40210EE954D6993D, double 0x4017E3A05579AB17, double 0x40113D4B6F6EC55A, double 0x4023C1FF51907A19, double 0x4021B6B52610A2E3, double 0x401D90E8168389B5], [10 x double] [double 0x4017B37D9F512036, double 0x401FC2554E3DCBD4, double 0x4019CBCB0659EDDA, double 0x3FF32A4FD1AF4D4F, double 0x40214B75DEB9919B, double 0x4015325C8AC571CE, double 0x40230A16769C444A, double 0x3FEC4A73028C6DA2, double 0x4020DD3AEF65C754, double 0x4021B2ECF2BECC5C]], align 64
@__constant_40xindex = private constant [40 x i64] [i64 3, i64 6, i64 0, i64 3, i64 4, i64 5, i64 7, i64 1, i64 5, i64 3, i64 6, i64 7, i64 8, i64 2, i64 4, i64 8, i64 9, i64 2, i64 4, i64 5, i64 8, i64 0, i64 2, i64 6, i64 8, i64 9, i64 1, i64 2, i64 3, i64 4, i64 6, i64 3, i64 4, i64 7, i64 0, i64 1, i64 2, i64 4, i64 6, i64 7], align 64
@__constant_11xindex = private constant [11 x i64] [i64 0, i64 2, i64 7, i64 9, i64 13, i64 17, i64 21, i64 26, i64 31, i64 34, i64 40], align 64
@__constant_40xf64 = private constant [40 x double] [double 0x4020561C9B413986, double 0x4009B9220FF54089, double 0x401D0AAB8A5CE5B4, double 0x40125B5AA715831F, double 0x4017C7B6FE2E6EA8, double 0x4018ACE2089E3433, double 0x4020563C105186DB, double 0x400821AC57E23F25, double 5.567300e-02, double 0x4008AC89B0EE49F5, double 0x4017E6195464DC23, double 0x4006E545846E8F2A, double 0x3FF0502BC72E275B, double 0x40216A2424A276B8, double 0x4013ECF5F4E4430B, double 0x401046A593A2DF93, double 0x40150B1F255F351A, double 0x4016C5B63D3E4EF0, double 0x400D652AC753E708, double 0x4011F1F6CACD184C, double 0x40165163779E9D0F, double 0x4020AAC7FBACB429, double 0x400141733226C3B9, double 0x3FFC86AF46AA087D, double 0x3FE42832B990AFE6, double 0x40126CE8D972CD7D, double 0x401CD93BC0A06EA0, double 0x400B4A1511DFFC54, double 0x4022F7A52AC753E7, double 0x40086537E2C55C96, double 0x400FD84988094E5D, double 0x4020411622813448, double 9.234180e-01, double 0x40215DFCC1871E6D, double 0x401372D38476F2A6, double 0x401361CC100E6AFD, double 0x4023F87DF5CF2496, double 8.198410e-01, double 0x3FE826527A20578E, double 0x400CA9142B302F73], align 64
