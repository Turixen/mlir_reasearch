module {
  ...
  llvm.mlir.global private constant @__constant_10x10xf64(dense<[[5.6718813029376314, 5.6667844328275514, 3.363512793904845, 4.2867022514564947, 2.9053849544431296, 9.1081131826765809, 3.9661029778944412, 4.5401935088482723, 7.4095446892900174, 3.7459431848846538], [8.1409989605347057, 5.7521713363256826, 8.8555417704135876, 3.9383641781681513, 1.8455847439564066, 9.4025723785474664, 5.8765187740863647, 4.3997462370956111, 6.9100629396277355, 4.1608901157013918], [0.95676785052815849, 6.7354541846351754, 9.2717354650667794, 3.0294985818710254, 9.2946257293100718, 5.257796897891831, 1.613824562978412, 7.3931205591451166, 0.51891760127506403, 0.067467657160750205], [7.3172470588125869, 7.0661807421228744, 9.4775695170014788, 4.1939195071049982, 5.2945884895455242, 6.9928290203161536, 6.6306057470675874, 9.9885709867304299, 2.0206886181157726, 3.0866717459610573], [6.1843062150198147, 8.2358382805119739, 5.1316689418259456, 8.4208768848997426, 4.3579604161615979, 6.5415473204093804, 4.5324242812468079, 0.99472660070575647, 5.4280090734320039, 0.31388584490193661], [2.4558681567545615, 2.9988303644028544, 1.6148298501915226, 2.5167835568413999, 7.0422284889738851, 7.838398030358789, 5.1694738966714056, 5.5289273089066082, 8.4423024998916727, 6.2315216867408552], [3.4525287330004106, 5.8455510087483198, 2.8668772077166782, 5.501793687844482, 2.9153866185952482, 1.471681328785549, 0.056280967951193306, 1.0321190696006466, 5.2665130627220735, 1.8464104631895506], [0.3756437447642369, 2.0643948029169579, 2.4151240139411101, 0.45808269010234826, 7.1015008225302108, 6.0882518363197811, 2.9559819074683826, 7.4837484843966448, 7.8178751540758808, 4.6956241080499561], [5.2041121662487857, 4.3267344708861257, 0.5310479151077474, 5.2426563730871845, 8.3609594609761757, 1.5385051067825817, 7.6294508448737508, 6.5966695196253085, 0.54113083307023357, 2.7841838233936023], [2.6574679464603301, 7.7012823439900071, 4.6604257289011013, 9.8209544859380475, 8.7162187562052331, 5.9220815376986362, 7.0782473738700071, 7.3967287065906895, 5.9952043636280603, 9.2058158812489257]]> : tensor<10x10xf64>) {addr_space = 0 : i32, alignment = 64 : i64} : !llvm.array<10 x array<10 x f64>>
  llvm.mlir.global private constant @__constant_5xindex(dense<[9, 0, 3, 9, 0]> : tensor<5xindex>) {addr_space = 0 : i32, alignment = 64 : i64} : !llvm.array<5 x i64>
  llvm.mlir.global private constant @__constant_11xindex(dense<[0, 1, 1, 1, 4, 4, 4, 5, 5, 5, 5]> : tensor<11xindex>) {addr_space = 0 : i32, alignment = 64 : i64} : !llvm.array<11 x i64>
  llvm.mlir.global private constant @__constant_5xf64(dense<[2.1531030000000002, 2.9941529999999998, 6.1803020000000002, 9.8754939999999998, 1.437303]> : tensor<5xf64>) {addr_space = 0 : i32, alignment = 64 : i64} : !llvm.array<5 x f64>
