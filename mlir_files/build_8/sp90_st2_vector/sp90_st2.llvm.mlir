module {
  ...
  llvm.mlir.global private constant @__constant_9xindex(dense<[2, 4, 8, 6, 0, 0, 2, 8, 6]> : tensor<9xindex>) {addr_space = 0 : i32, alignment = 64 : i64} : !llvm.array<9 x i64>
  llvm.mlir.global private constant @__constant_11xindex(dense<[0, 3, 3, 4, 4, 5, 5, 8, 8, 9, 9]> : tensor<11xindex>) {addr_space = 0 : i32, alignment = 64 : i64} : !llvm.array<11 x i64>
  llvm.mlir.global private constant @__constant_9xf64(dense<[6.9417270000000002, 4.472423, 8.6433560000000007, 7.1301490000000003, 9.2154410000000002, 1.526742, 5.686134, 7.139875, 5.5256660000000002]> : tensor<9xf64>) {addr_space = 0 : i32, alignment = 64 : i64} : !llvm.array<9 x f64>
  llvm.mlir.global private constant @__constant_10x10xf64(dense<[[0.40803604068288646, 9.6837447994095597, 7.4415762583411924, 9.6461451427407532, 2.1612697584067488, 1.0841491891053034, 5.8333663037433965, 4.6836259258338808, 5.5421106036694168, 7.8433365908421422], [5.2906001263652129, 3.8513224132184698, 7.4905265945081556, 8.4891317513399915, 5.1350483111058427, 8.990365879483015, 1.2759293650616621, 6.7808682903243085, 6.1215314357835684, 8.8970006060305842], [7.60000889182853, 9.3600344410475617, 1.8956743972485512, 8.7727230143732235, 0.28226442309511546, 9.6253416428245355, 2.2271487145422642, 0.39238027006464393, 5.637978968056867, 3.0842211565515179], [1.4435263921086749, 6.7219325457845134, 5.5137995038368901, 7.0296607548046284, 9.1965060952852689, 3.6479088784490612, 7.8583704896811221, 4.7348174106380769, 9.3039560713411582, 5.858595337278433], [9.991300758048391, 2.3104314645547399, 2.6219281968503614, 9.2301398874032187, 1.4649326933627205, 0.046340251210158501, 6.0105461449408368, 8.474721294085823, 3.0726830512575889, 8.7208201029211381], [1.5252101024782938, 0.47799360996902296, 8.9121717938584162, 4.7330727281651974, 5.3800735473331933, 6.5614355599079186, 7.3456012949667997, 1.654753160738609, 9.4846157924567737, 4.1543381728297337], [8.0173779082957246, 4.3392119219254166, 4.8237968880591122, 5.9268247350760559, 3.3682095671118253, 7.5927793080134176, 0.24498060468052252, 0.27394927746192677, 0.27650653661441149, 1.3186611601530629], [1.3156478154891371, 8.0362367890953674, 0.44301391270632373, 2.0141354016685842, 5.2589915221027637, 3.6316513406597983, 2.5285263722865672, 8.1867314022691246, 7.4295591545697519, 1.5398268088360711], [0.050461580702949593, 0.69384886211150021, 7.2164104663929551, 0.9624974718302437, 6.0172389799543877, 8.1187932329576995, 3.2146112863899301, 5.6332561750099099, 0.92420069700703711, 4.4418411997489553], [1.397412000400986, 7.9732853353461994, 2.5064512789355451, 0.19699913045786666, 9.2461063578854112, 6.4827315065373501, 5.1731312666210547, 6.4227826915683028, 6.3009524046445664, 0.8590942542773039]]> : tensor<10x10xf64>) {addr_space = 0 : i32, alignment = 64 : i64} : !llvm.array<10 x array<10 x f64>>
