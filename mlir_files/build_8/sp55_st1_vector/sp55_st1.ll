...
@__constant_10x10xf64 = private constant [10 x [10 x double]] [[10 x double] [double 0x40179025BA56212E, double 0x402291881826E902, double 0x40073C9912C4A49A, double 0x401C3240E8217CBD, double 0x3FDC870E61610C20, double 0x4011A5DE34043B39, double 0x40139FF5489977EA, double 0x402393F3CC711290, double 0x4003417A002487C1, double 0x40066B1511417DAA], [10 x double] [double 0x4007544A10985600, double 0x402105637DA1B4C7, double 0x4021AA6D6331745A, double 0x400B568F419967C4, double 0x401CA6398B530CC3, double 0x4017DD38F76D8536, double 0x3FEEF3F127573B42, double 0x4021A7DFD4565B58, double 0x3FE75EAC3BD2459E, double 0x3FC2B71D16D58278], [10 x double] [double 0x400F64822E663768, double 0x400188AB6D870208, double 0x40190E9DF43867B6, double 0x401460EB7B7A4DB6, double 0x40183508FC28C616, double 0x4013935924AF9E28, double 0x4017940B73BAFA3C, double 0x3FF0C653AC8C9C2D, double 0x40106EDF59A3E3CB, double 0x3FF4C0FB1060AACD], [10 x double] [double 0x4018877BB5932EFA, double 0x401FA37E9D8A4FEB, double 0x400FFD68CB98732F, double 0x4015D715E988FCA7, double 0x400D8AED9C5DE44C, double 0x401D2F53344B66CF, double 0x40233FF89ADAA4AA, double 0x4020C103E551A428, double 0x4015682DF8C883FE, double 0x3FF9060E219A2D03], [10 x double] [double 0x401FCD299DD5213E, double 0x3FC15CAD72894E68, double 0x402070DC9F737011, double 0x401CA3DCDA33725C, double 0x3FFF32443E5D03D0, double 0x3FD8893115CDD6A0, double 0x3FF4562646E26540, double 0x401A9505F33A750D, double 0x3FEE05B965AEC77E, double 0x4012D3508040A7D2], [10 x double] [double 0x3FFDF3F9D777AD84, double 0x401733CAD776469B, double 0x40007B7ECAA6F276, double 0x4012EEC1090330E8, double 0x401464D81DAEDF78, double 0x3FEF632071B19856, double 0x401859A94A264F25, double 0x400B3666089FDB5E, double 0x3FE3BB7EF7EBCC8E, double 0x400D935A7C4CD50E], [10 x double] [double 0x402120A7664BCEFE, double 0x40168617692B6954, double 0x4006DD787ACE6C24, double 0x3FFABB03B783DD09, double 0x400A7D38AAEA49E7, double 0x40000FC9DCAC5C66, double 0x401743B93A873C1E, double 0x40226962B51BDF64, double 0x401BA4E43DAC32A8, double 0x4022A30DD0210249], [10 x double] [double 0x40221F1052F7018C, double 0x4012A6E1AB1B92AC, double 0x3FE26EF361254B78, double 0x401586293D94A63B, double 0x40086AEDC9E5519A, double 0x401FCF6A60CAF7DA, double 0x400C6F909BB42F14, double 0x400DB30EB6940E9C, double 0x401953F381BDB150, double 0x402314AE9A074EDF], [10 x double] [double 0x4016BE81640F9870, double 0x401EC6C1BDE51451, double 0x401192DC5838AEBE, double 0x402223F4D0E57CF0, double 0x400CD4F9C7C7382A, double 0x402068D0B429B072, double 0x40174F9DCC2F0A27, double 0x4017615533AC19D3, double 0x402358EAB3874369, double 0x4012C9C5744689ED], [10 x double] [double 0x400F235AE401B8E4, double 0x4017F67FBDD2AEAC, double 0x4011823209192310, double 0x4015337FA46DCA92, double 0x4003A0BCDD155C45, double 0x3FD1B71CDDFAB280, double 0x40160385661A9429, double 0x400B4285133CCE02, double 0x3FD5EDC31E6F3544, double 0x4020335B915D91D2]], align 64
@__constant_45xindex = private constant [45 x i64] [i64 0, i64 4, i64 5, i64 6, i64 7, i64 1, i64 3, i64 5, i64 7, i64 1, i64 3, i64 4, i64 5, i64 6, i64 7, i64 0, i64 1, i64 4, i64 6, i64 7, i64 0, i64 1, i64 4, i64 6, i64 7, i64 8, i64 2, i64 3, i64 4, i64 9, i64 0, i64 3, i64 4, i64 4, i64 6, i64 8, i64 2, i64 3, i64 6, i64 3, i64 4, i64 5, i64 6, i64 7, i64 9], align 64
@__constant_11xindex = private constant [11 x i64] [i64 0, i64 5, i64 9, i64 15, i64 20, i64 26, i64 30, i64 33, i64 36, i64 39, i64 45], align 64
@__constant_45xf64 = private constant [45 x double] [double 0x401FF810A569B175, double 0x400832734F82F512, double 0x4011C8E2E2B8C75C, double 0x40230AB4FA48301A, double 2.473960e+00, double 9.493780e-01, double 0x4019D8194C016052, double 0x401C87357E670E2C, double 0x401DD95C853C1483, double 0x400A463CFB3311A5, double 4.439990e-01, double 0x4022D4C660A20147, double 0x400C9794A6EB91B4, double 4.994940e+00, double 0x4017C353B4B2FA94, double 7.734600e+00, double 0x402394A72EAD9275, double 0x40180C08FA7A8501, double 0x4014316440F23897, double 0x40168210BE9424E6, double 0x4009F83382E44B6F, double 0x40186785B5B70692, double 0x4004E16BDB1A6D6A, double 0x40183565C2D27807, double 0x401D00FA58F7121B, double 0x40201DBA4D6E47DC, double 0x40221A2D948DC11E, double 0x4023C355EF1FDDEC, double 0x40014ED6FDA836EB, double 0x400991422CCB3A26, double 0x401C6D490E66CB10, double 0x4017811233DF2A9D, double 0x3FF0BD102BC72E27, double 0x400194C55432873C, double 0x40090DAF4ADBC665, double 0x402071B23DD54DA5, double 0x40202A8CBD1244A6, double 0x4012B3365881A155, double 1.086580e-01, double 0x401B93C579F23465, double 0x4015B6638433D6C7, double 2.960000e-04, double 4.536030e+00, double 0x401BFA960B6F9FCB, double 0x401D2FACE67D77FB], align 64
