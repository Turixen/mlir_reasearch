...
@__constant_10x10xf64 = private constant [10 x [10 x double]] [[10 x double] [double 0x401F8BA55F654BF9, double 0x40183789FA07C99E, double 0x40141506DFE497A7, double 0x401EC05A95D6F091, double 0x400A19362E02F888, double 0x401AAEB5F246C2E4, double 0x4022F733700B3008, double 0x3FFFD0639480EF02, double 0x40229A23E3FB24A0, double 0x4020D829A9DF28A2], [10 x double] [double 0x401A4B844504B3F4, double 0x3FFC4A169D4989CC, double 0x401BDF7999B7D642, double 0x3FA626081721D300, double 0x400D473ADF76ACA6, double 0x40175032B8573491, double 0x3FF91C939F6C6F52, double 0x3FF5AEC20A5334BA, double 0x4021FD8A6EF9347D, double 0x40079C9976CE8B20], [10 x double] [double 0x40140CCF62991361, double 0x3FF4CEA1BACC85EB, double 0x3FF72A71F5B39360, double 0x4023C694A6548636, double 0x3FF306D51DADF753, double 0x40111C5422A5C562, double 0x40152B5A37A9C042, double 0x3FC6692EE42CAB90, double 0x40223DFC9EEB35E7, double 0x3FE894C6276AEECA], [10 x double] [double 0x401F46591842EFEB, double 0x4020EC145A5258B1, double 0x4020F4116D6951EE, double 0x4015793AEA304810, double 0x40166194247DBF8E, double 0x4018DAEB4F1C5AF7, double 0x40238C070BF70540, double 0x4013CE35CAC499F1, double 0x4022D64DB1EEBCCD, double 0x401EC933E2BE5A40], [10 x double] [double 0x402153BC2137AA7A, double 0x401EC40EC4906463, double 0x3FF5D60D34DDD498, double 0x401418CB64A797C4, double 0x4023F7F773CCF5B2, double 0x3FD5F8FD52CCB2E0, double 0x4008B907846B3752, double 0x40177F1BE95F1897, double 0x3F900FC6B95D4040, double 0x3FFF1A9C897039FB], [10 x double] [double 0x3FE1EDA261D6D5AA, double 0x401E63F01FCA7B3D, double 0x4020583CB503BCFD, double 0x4019861EB862CD9C, double 0x401CB9C1B5571DB1, double 0x4023AA6250061A43, double 0x3FFE6854ED907B21, double 0x401D80A0B5797512, double 0x4006F5EA5A8E481E, double 0x4023991F2A0145DD], [10 x double] [double 0x4022152F2EFDDEE3, double 0x3FCBB0DAEA3FEE90, double 0x3FD621AB11289490, double 0x402111C36F31FD1E, double 0x4011FC06D8EF2797, double 0x401249B7B9A6358A, double 0x40207869302D02CA, double 0x40139070AC868353, double 0x402150DE7377EC41, double 0x401101C47E244574], [10 x double] [double 0x3FF47CD8FBB886A1, double 0x40201FD7D8D74FC2, double 0x4005109783771BD2, double 0x40084D93C24D9E5A, double 0x401086EA7FC7B2FE, double 0x401E622615CE5F21, double 0x3FF8B1B079387540, double 0x4011F09127A4E339, double 0x40171F775288E1F3, double 0x4022979AE26F3343], [10 x double] [double 0x4022B4797E5D349A, double 0x401186C77F22A97A, double 0x401FAA15FA66636C, double 0x3FF1999BA1B94BD6, double 0x4013579DE83551F4, double 0x3FF9ED7282AA163E, double 0x3FE5ADB3312F70AE, double 0x4009FCAD2B40B7CD, double 0x4001865641F032A0, double 0x4021C0393E4E3997], [10 x double] [double 0x400022AF44BC9B70, double 0x3FFC660A60AA4631, double 0x400E5F977823C1CE, double 0x4012568450570876, double 0x401B1827F810FFF6, double 0x3FE809E327E405E4, double 0x40101C0B2086A82E, double 0x401E79731D6F5EF8, double 0x40097BD704DE58DC, double 0x400EE13F0A11ACE4]], align 64
@__constant_50xindex = private constant [50 x i64] [i64 4, i64 7, i64 8, i64 9, i64 1, i64 2, i64 5, i64 6, i64 9, i64 0, i64 3, i64 4, i64 9, i64 0, i64 1, i64 2, i64 5, i64 7, i64 0, i64 1, i64 2, i64 3, i64 4, i64 5, i64 9, i64 0, i64 2, i64 4, i64 8, i64 9, i64 1, i64 2, i64 4, i64 5, i64 7, i64 8, i64 0, i64 2, i64 3, i64 6, i64 8, i64 0, i64 1, i64 3, i64 6, i64 7, i64 8, i64 3, i64 5, i64 9], align 64
@__constant_11xindex = private constant [11 x i64] [i64 0, i64 4, i64 9, i64 13, i64 18, i64 25, i64 30, i64 36, i64 41, i64 47, i64 50], align 64
@__constant_50xf64 = private constant [50 x double] [double 0x401615A038194C01, double 0x401E42FC69728A61, double 0x401DC81B21C475E6, double 0x401F583F4ECA686E, double 0x401C3C8FFB8B2639, double 0x3FF8A20AB7132724, double 0x4023E19D883BA344, double 0x3FFC06F36EF80560, double 0x40196C86CEBBBA56, double 0x401A293C03BC4D23, double 5.876310e-01, double 0x40059EAB367A0F91, double 0x400BEFCAC8E68E3F, double 0x40187990F301EABC, double 0x4001FA250F840182, double 0x4011AF3C2DADB835, double 0x4003BE996312F4CF, double 8.308400e-01, double 8.070630e+00, double 0x40127C4A4095F245, double 0x40203CEA4A8C154D, double 0x4023C415097C8084, double 0x3FF56BD6E8AF8162, double 4.101730e-01, double 0x3FF12E5CD4ED2CBF, double 0x40101D7E889C1B54, double 0x401A96AEC0724B77, double 0x402355BAD3A604E2, double 0x3FF8D797CC39FFD6, double 0x400BAC636B096356, double 0x4001841C3EFAE792, double 5.695810e+00, double 0x4008750E34762952, double 0x3FF554CCAB3EDD8B, double 0x401584FB1183B603, double 0x40119D88C1DB0143, double 6.441150e+00, double 6.730030e-01, double 9.233270e-01, double 0x401C99EC2CE46499, double 6.253840e+00, double 0x400595C4A83B1D0D, double 0x40063A5D28D002E2, double 1.587070e+00, double 0x4013DEB52C9D16FD, double 0x40141FCF80DC3372, double 0x400B39FA11A975B0, double 0x400C628AA433508F, double 0x4006470F3882278D, double 0x400DB62E90364389], align 64
