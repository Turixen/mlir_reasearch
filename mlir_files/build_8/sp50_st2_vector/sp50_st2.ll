...
@__constant_10x10xf64 = private constant [10 x [10 x double]] [[10 x double] [double 0x400C9F01668AF6A6, double 0x4000FAB97521C78C, double 0x4005769AE81885EC, double 0x400367E1C34B85D4, double 0x400DB3C680DE6A03, double 0x401E9BEF69180101, double 0x3FD804623B58B45C, double 0x400FB11A4E3433D7, double 0x40177A3FC7FA3562, double 0x401123DFC01D51B4], [10 x double] [double 0x402038BF6EFF3AC4, double 0x401DCDA61B8F00D7, double 0x4020073F09598EC0, double 0x4012DB5170B34377, double 0x3FEC51FF1BD8FD82, double 0x401D3D4660A5F36E, double 0x40213D9507576690, double 0x3FD9034B44F5D40C, double 0x4004743AF4205ED0, double 0x401B309F47FD9017], [10 x double] [double 0x401FD9C2EECE2586, double 0x40152B5BB9A31C58, double 0x4015B3E7CC0D05F0, double 0x4019345992D1A76A, double 0x40124A1C3A1534E6, double 0x4022278733B27FCB, double 0x4015DDEC550DA524, double 0x401266183E0896CE, double 0x401F766A4642319F, double 0x4022F74F8DA57A04], [10 x double] [double 0x40232468525D6D02, double 0x40177CB2DDEF68C5, double 0x4021108B46460482, double 0x3FBABCE2DF6EE0D0, double 0x4013028E89549A7C, double 0x40130890A619E360, double 0x400DFE3D661A55B2, double 0x4011F85088D246C4, double 0x401AF765CE7147C5, double 0x40138540F25CD15F], [10 x double] [double 0x4013CEF84485CC4E, double 0x401F728883659D97, double 0x3FF6090FE90FE8A4, double 0x40239A92A6E59DF6, double 0x4010008328A2E980, double 0x400C2E289F6206EE, double 0x400C0E2B5F2EBACB, double 0x4007273DBBD5C7D2, double 0x3FE3E71F6C175B16, double 0x40040CDBFDB392B8], [10 x double] [double 0x4012D521E4C93121, double 0x401B689B7473ECDF, double 0x40021279EB40CEBC, double 0x400D6E8CC26802E2, double 0x401CE05336CB6920, double 0x3F6E1FCBE6D7B000, double 0x401E7BD9429250D5, double 0x402138CB9495E3DB, double 0x4014602E5E053C13, double 0x4010CBF15AE3C230], [10 x double] [double 0x400BDA229256A606, double 0x40129A40A774C9A9, double 0x40232F76CDEC8E0C, double 0x401A7EE104EA63D8, double 0x3FD55726C747EF28, double 0x40117ACD840A0B6B, double 0x40047D3B62D96988, double 0x400137A9D71612CA, double 0x40236AAFC02F7488, double 0x402221DD50B26EF9], [10 x double] [double 0x4021C45619932CEB, double 0x4019C0A59FC825AD, double 0x401573D18EEA1922, double 0x3FD924CED3535CFC, double 0x3FD47F189BDE807C, double 0x402090C1FA93212D, double 0x4017E140EBCE73F7, double 0x4010B56C656E6524, double 0x40185F779CA0AFAC, double 0x401270A78FCDC09A], [10 x double] [double 0x40140AB740980C02, double 0x3FDDEF5AC36FEA34, double 0x4018CEC9EC7F2C85, double 0x401B080A005D88E8, double 0x4012AF69C8849F76, double 0x401797A684C374DF, double 0x3FBBCB34FCE790B0, double 0x400E31DBF43C8DB4, double 0x400C69AFE725C47B, double 0x40107C6E2D5F396B], [10 x double] [double 0x4022FF33C15EDF16, double 0x4021934B9DD592D8, double 0x40104FB78FF9C25C, double 0x4012A028F1D25130, double 0x4012B6EC13243690, double 0x3FDF1D31C021964C, double 0x4001EDC8CAAD592C, double 0x40147A3AADA9C970, double 0x401B36CC2F06FEFC, double 0x400AA01E0352D2DE]], align 64
@__constant_50xindex = private constant [50 x i64] [i64 0, i64 2, i64 4, i64 6, i64 8, i64 0, i64 2, i64 4, i64 6, i64 9, i64 0, i64 2, i64 3, i64 4, i64 6, i64 8, i64 2, i64 9, i64 0, i64 1, i64 2, i64 3, i64 4, i64 6, i64 8, i64 0, i64 1, i64 2, i64 3, i64 0, i64 1, i64 2, i64 4, i64 5, i64 6, i64 8, i64 0, i64 7, i64 8, i64 9, i64 0, i64 1, i64 2, i64 4, i64 6, i64 7, i64 8, i64 9, i64 7, i64 8], align 64
@__constant_11xindex = private constant [11 x i64] [i64 0, i64 5, i64 10, i64 16, i64 18, i64 25, i64 29, i64 36, i64 40, i64 48, i64 50], align 64
@__constant_50xf64 = private constant [50 x double] [double 2.091000e-01, double 0x3FF346D3F9E7B80B, double 0x400CF8BEF8CEB357, double 0x40135E8C47A17F41, double 0x400F455B035BD513, double 0x401241B0468448CF, double 0x400866AE3A3A8E71, double 9.951830e-01, double 0x4017B4DDB5525CC4, double 0x400380C4156E264E, double 0x4013863022DD7A9A, double 0x4021C35568E820E6, double 0x4022F3C3C5BD0E13, double 0x4018782A5614DF8B, double 0x4019B138BCDFEFBF, double 0x3FFC5285A921CCD9, double 0x4021F82AFDDA8BD2, double 0x4023A2D6ECE13F4B, double 0x4021D73F748A1598, double 0x402387DB4CC25072, double 0x3FFF5287C200C0F0, double 0x401A2EDA22F6A50D, double 0x4004C496EDEDAEC5, double 0x401184B945308BB9, double 0x3FB16323BBC6EB0B, double 0x401AF72EAD9274E2, double 0x401C2387DF5CF249, double 0x3FFF3C23315D701E, double 0x401EDB93CCD0FE8B, double 0x401ADF676EA4228A, double 0x402158E94EE392E2, double 9.332670e+00, double 0x40170B2C83EC892B, double 0x401D6D3ED527E521, double 0x4002895B78CC9A78, double 0x3FEF8856E696A26E, double 0x400B4621B7E0AC7E, double 0x400267FB267C6B8B, double 0x4017CC91D14E3BCD, double 0x3FE9EACC92146A1A, double 0x401CE2AA9F7B5AEA, double 6.089370e-01, double 0x3FFC0F96E158750C, double 0x40104E17E34B9453, double 6.402430e-01, double 0x4011EE7924AF0BF2, double 0x40099068986FCDEE, double 0x400A47021D10B1FF, double 0x400293D20F2BECEE, double 0x40132FB7A5F41AEF], align 64
