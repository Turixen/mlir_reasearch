...
@__constant_10x10xf64 = private constant [10 x [10 x double]] [[10 x double] [double 0x400D57BDAAF83978, double 0x40181D51984A62E2, double 0x4021DC8159E2A4BA, double 0x402071A6813D0BEE, double 0x3FFF26D4BC05FCFE, double 0x401675FF174D6936, double 0x401D3F78967A5322, double 0x3FFD384207291A50, double 0x40109F36871A6B18, double 0x40152012AFF7F73B], [10 x double] [double 0x400565909301886E, double 0x401CCD48CFFC7F7A, double 0x40153322F42CB137, double 0x402088A757C29BF9, double 0x401ED6BE137F5986, double 0x401E9C39A636D222, double 0x400349E0C6B86C18, double 0x3FE5CA245F1EFA4C, double 0x400BB119D0D8757D, double 0x3FD25691F393E214], [10 x double] [double 0x400DE9C674E9ECC0, double 0x40151BEFF9EA9C6E, double 0x3FD3D47431C7A924, double 0x4015D8B7E4F2733D, double 0x4023292BD97A4AEA, double 0x4020ACCCB0DA2A90, double 0x4013F5D460E0989D, double 0x40044120618621AE, double 0x400F5F5D3CE558EF, double 0x3FAB81FABDEA7A40], [10 x double] [double 0x401230C81B86BC74, double 0x4021317ADC9AA8B2, double 0x4015C8A9367EFB4A, double 0x40198EB5C3D00662, double 0x40097C1B42CFA227, double 0x3FE634733C2A31F0, double 0x40115E02A92F7F74, double 0x400A82D8D2233497, double 0x4022B70B1A6EE858, double 0x4015B9843260C110], [10 x double] [double 0x3FFAFF65BD9248E7, double 0x400B86D1A973AB64, double 0x4022F2EA096EBDBC, double 0x402390ABF48F1930, double 0x400F8FE644F119C5, double 0x3FCAF413CD8B3C48, double 0x40146EB75EB96E7F, double 0x3FFE4243EE4F02A8, double 0x4023E969E3521BB8, double 0x40181F2C35BDE7D9], [10 x double] [double 0x40210D8D6E89D71D, double 0x3FEB80B98B45C5B4, double 0x401639A6B5D8213B, double 0x402246CE2735E5D0, double 0x4014D9993AEA6877, double 0x3FF7320608FC4421, double 0x401FDE3B9EEBC54C, double 0x3FE43A34684BE48A, double 0x4006603C98A6B45C, double 0x3FE1B2C98EF504DA], [10 x double] [double 0x3FDD90D7C3B7D3F8, double 0x4012EB092949B1B4, double 0x3FFF9056168E5B81, double 0x3FFF96794A34AD3B, double 0x401743359B8F0C4E, double 0x400C3D6D37EF124B, double 0x40143FBBE42DFC1A, double 0x4021524AD6F1B85C, double 0x400FD2015BFF9157, double 0x3FCC4635751E06B0], [10 x double] [double 0x40236F3608E3F91F, double 0x4022AF03CFAD7263, double 0x4022DAC22D474686, double 0x401F0B4B68052BE8, double 0x3FFFC3C59443C352, double 0x4006181D0943EAB4, double 0x4009C26334D4E1A3, double 0x401EF9F8FFD2D652, double 0x3FAC803305F5A440, double 0x4022C104EAE5F22C], [10 x double] [double 0x40195911809A4CD0, double 0x402102F50BAA24B7, double 0x3FF5A92924FEAD47, double 0x40147D9041C61876, double 0x3FF35B5157803E93, double 0x40031AF59DCB7D62, double 0x3FEE25E179B82326, double 0x3FFBD0EBA5FDAF7F, double 0x400DCA5A0D6CA7D8, double 0x3FC7256DF2F732C0], [10 x double] [double 0x40206392DE326873, double 0x4016F87E0977C5F6, double 0x3FF28A459869A67A, double 0x40102EDC10D5DD98, double 0x4023BBA9D51D5884, double 0x4021CE89439CBC88, double 0x4019E8EF1B06C997, double 0x4018F324ED7F775A, double 0x4021D785E08F1E73, double 0x400939D06EECD240]], align 64
@__constant_35xindex = private constant [35 x i64] [i64 0, i64 2, i64 4, i64 6, i64 7, i64 8, i64 9, i64 0, i64 2, i64 4, i64 6, i64 8, i64 0, i64 0, i64 1, i64 2, i64 4, i64 6, i64 8, i64 1, i64 0, i64 2, i64 4, i64 6, i64 8, i64 7, i64 9, i64 0, i64 2, i64 4, i64 6, i64 8, i64 2, i64 4, i64 8], align 64
@__constant_11xindex = private constant [11 x i64] [i64 0, i64 6, i64 7, i64 12, i64 13, i64 19, i64 20, i64 25, i64 27, i64 32, i64 35], align 64
@__constant_35xf64 = private constant [35 x double] [double 5.667040e+00, double 0x401F23B107746888, double 0x4021911A32B12D34, double 2.128210e+00, double 0x4022A720EA5B530D, double 0x4004CFAD6CB53501, double 0x401B2C69F8C21E1D, double 0x402030B5CBFF4773, double 0x3FFE29D8409E55C1, double 0x4007AC9EA9A3D2D8, double 0x4012C11B60AE9681, double 0x40009762D83C6C98, double 0x401ABF809917939A, double 0x40030A58B3F63C32, double 0x4022B9D81F106680, double 0x401820C23FAB10BA, double 0x401B0AB474107315, double 0x40229B87160956C1, double 0x3FF5FEC99F1AE2DA, double 8.251350e+00, double 0x401E83F077CCC038, double 8.302780e-01, double 4.431330e-01, double 0x3FF2D2AB68CEF673, double 7.563830e-01, double 5.962980e+00, double 0x4002A6D938151A43, double 0x401B3858793DD97F, double 0x401360E6F2E8C048, double 0x400F951697F1F9AD, double 0x402163CFF64CF8D7, double 0x401454ABA3875925, double 0x4004F31EC0B56755, double 3.853600e-01, double 0x402130BAE89EBA6B], align 64
