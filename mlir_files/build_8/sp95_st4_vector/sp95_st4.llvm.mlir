module {
  ...
  llvm.mlir.global private constant @__constant_10x10xf64(dense<[[1.3831952246478896, 6.5439173898531848, 8.4520056534154797, 1.6455805597850692, 1.4422466679105161, 3.9397220392479637, 3.7732869896944008, 8.2883701372554999, 5.0119193007480103, 6.4245127253130825], [5.9059880610255373, 1.1882729812917758, 9.357032096666721, 5.2435351616056156, 0.69733388172009358, 8.0196780867779811, 0.12949914543252561, 1.4054019862124878, 0.97811961145545689, 7.0940553557447679], [2.8645547804845464, 0.067040402960059087, 4.6399164811818814, 8.2567260077843265, 0.22386001927192756, 8.8647522922101452, 4.9795093374285413, 9.6577161900076796, 5.1316369810494686, 1.3644782155753121], [9.4242705157786161, 5.2300217394176975, 1.1897161898038477, 0.72310940872520657, 9.2203455453799563, 2.0861758794842791, 3.2472232554480085, 7.9672586492431554, 0.067096898881781053, 7.2236768693876812], [3.9119159002942059, 0.62633821333298423, 9.2498823018469274, 0.41557436324782038, 1.9466984469918991, 2.7531056435846155, 3.5636624204715597, 5.8555419028507538, 5.2991641556023854, 2.9698562573532996], [6.1748280668272297, 5.8450321603883557, 9.6426909473331186, 5.1666488246358604, 6.8155393639180684, 3.4904262538275823, 2.400791312310977, 7.4399962177746239, 3.4110819275862179, 4.4040111872219327], [7.4231713854535908, 7.1379735905495725, 8.7806247417899623, 0.96813831198988232, 1.025140079474901, 9.7306860070934249, 1.9927009283969577, 0.22701157406958661, 6.9201296351203343, 3.7579316600251502], [3.1275284057511876, 4.8045417162081963, 1.0731123697560963, 2.5620129377518372, 1.8739022581064235, 7.499027490316319, 3.6574478414349807, 2.071828935258706, 2.8526421954198389, 4.4317880371300493], [9.2239972584560305, 6.6633599571345572, 6.6882677755259383, 1.3832832251102356, 1.8901416035788143, 7.2973408486462112, 6.0614343823675938, 5.7359364161176973, 6.4651129452208842, 3.3754172271855163], [2.8860916893856636, 1.6069077571400736, 5.525479439804263, 6.3462640709689042, 1.5423496351010468, 6.6334706732253768, 7.3414870703870969, 8.1225276787120286, 4.5045333106296681, 2.6301491807426203]]> : tensor<10x10xf64>) {addr_space = 0 : i32, alignment = 64 : i64} : !llvm.array<10 x array<10 x f64>>
  llvm.mlir.global private constant @__constant_5xindex(dense<[4, 0, 4, 0, 4]> : tensor<5xindex>) {addr_space = 0 : i32, alignment = 64 : i64} : !llvm.array<5 x i64>
  llvm.mlir.global private constant @__constant_11xindex(dense<[0, 1, 1, 1, 1, 3, 3, 3, 3, 5, 5]> : tensor<11xindex>) {addr_space = 0 : i32, alignment = 64 : i64} : !llvm.array<11 x i64>
  llvm.mlir.global private constant @__constant_5xf64(dense<[4.1864929999999996, 1.8583229999999999, 6.8095549999999996, 9.7107150000000004, 5.635200e+00]> : tensor<5xf64>) {addr_space = 0 : i32, alignment = 64 : i64} : !llvm.array<5 x f64>
