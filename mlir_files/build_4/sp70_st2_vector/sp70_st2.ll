...
@__constant_10x10xf64 = private constant [10 x [10 x double]] [[10 x double] [double 0x401C8F96FEFCEAC7, double 0x401E3A1ED975DE0E, double 0x40132B8BA83DE6A8, double 0x401991C898707D11, double 0x3FF707A38A9957E0, double 0x3FFF02625C5F906C, double 0x4004871416A988E6, double 0x40169B54687FFAA0, double 0x400E2B8B4FC49B92, double 0x40199B6407A022B3], [10 x double] [double 0x3FE3C7FC0A414FD8, double 0x4021DECB5521E5BB, double 0x3FFCA1730250D9CA, double 0x400D3E1E50C8D184, double 0x3FCD4FF7D4A14AF8, double 0x401DB9C2EBC3CEF2, double 0x3FE070B0CA5E0712, double 0x400892B26A48CE0A, double 0x4013655C404B2040, double 0x401FEAA0876BAE7B], [10 x double] [double 0x4003BE1CB2DF980C, double 0x4021481C2AE5565E, double 0x402337DC48F31513, double 0x3FF56958CBE8CABD, double 0x40160009BF3F5016, double 0x401D3C228668C420, double 0x3FF52ADCEB06113B, double 0x40115D592305B286, double 0x401F913FBFCB9651, double 0x40222500E70A2021], [10 x double] [double 0x400F07F67A553CD4, double 0x400286D12956C190, double 0x4007F85FD6989AB0, double 0x4021D475A8394AD9, double 0x40237162BC16EC36, double 0x40041B849FA608F0, double 0x4023B9DC685A1A32, double 0x40147A26D8178701, double 0x400ED1506871A516, double 0x4023138BDBF52037], [10 x double] [double 0x3FFE4D333B991478, double 0x4016DDE840E0978D, double 0x401E95D20F5DC8EC, double 0x4010B98F8950E1A6, double 0x401D524C24B86AB4, double 0x40216164C89A661E, double 0x401719CDBA263505, double 0x400AB3000A24B580, double 0x4011C700D778C81E, double 0x3FC82D5D9124BE98], [10 x double] [double 0x401200E72F257BE2, double 0x40210F66BF0C5913, double 0x401DA9A8CBFFEDC3, double 0x402163108A4A43AE, double 0x4007AEE1DF2270C7, double 0x401CCD04DA7A4006, double 0x3FFE647972DF116E, double 0x4007985FCE986673, double 0x4000ED054D0049B8, double 0x4011673F61B34016], [10 x double] [double 0x40216A94201EB812, double 0x4017DD271C69A915, double 0x3F75314E6A2DCE00, double 0x401FC60AF16EEABE, double 0x400AE4DD5A4C2647, double 0x40108238B8AA4F98, double 0x3FB6FCD13C6EEDA0, double 0x4021625878CE0215, double 0x401D6A819C83BF78, double 0x4004546AAFD08930], [10 x double] [double 0x401ED22C162CD7FA, double 0x40132CBED94CEF9F, double 0x3FE084A9B8FF5860, double 0x4003FDF7A970DF82, double 0x401BB74E0E314E50, double 0x400D3806D239E6AA, double 0x401720DA2D2C5E2A, double 0x402205FF49B75B7B, double 0x400F6A9F72A96DF2, double 0x3FF3B6ACD7BCF667], [10 x double] [double 0x40075AC966EDD0EC, double 0x3FDE5BB9AEEA1FF0, double 0x4015C715E2064D4C, double 0x3FE8828F3C026FD2, double 0x402068F843243127, double 0x400DD6504B66B180, double 0x4020AE7ACD5AC842, double 0x400129DDA1A48920, double 0x40039F70AC3EDF0A, double 0x4021DE9762743D90], [10 x double] [double 0x40238569EF98603F, double 0x40079F1547CFEF3E, double 0x4012B45F975924EE, double 0x401A0CA2D12F830D, double 0x40120B695F96DC65, double 0x4021A11C30AE2120, double 0x4022D0FE5D7EE03C, double 0x401DECF2DF3054B7, double 0x4017656C2FA9DECA, double 0x3FEF399F062BF220]], align 64
@__constant_30xindex = private constant [30 x i64] [i64 0, i64 2, i64 4, i64 6, i64 8, i64 2, i64 0, i64 2, i64 4, i64 6, i64 8, i64 0, i64 2, i64 4, i64 6, i64 8, i64 5, i64 8, i64 0, i64 2, i64 4, i64 6, i64 8, i64 6, i64 0, i64 2, i64 4, i64 6, i64 8, i64 3], align 64
@__constant_11xindex = private constant [11 x i64] [i64 0, i64 5, i64 6, i64 11, i64 11, i64 16, i64 18, i64 23, i64 24, i64 29, i64 30], align 64
@__constant_30xf64 = private constant [30 x double] [double 0x4010CC59FB1E18F0, double 0x400A0A65492FF4BA, double 0x400FCCA3E7D13511, double 8.850050e-01, double 6.616020e+00, double 3.111840e-01, double 0x4019712018A43BB4, double 0x3FFF8F3DC054EF46, double 0x400235182A9930BE, double 0x40226AE557DE0D67, double 6.989440e-01, double 0x401129FF4FD6D7E9, double 0x40225709B738E6D1, double 0x40238CE0114D2F5E, double 7.130100e-01, double 0x401AE0CD423D9232, double 0x401C55332ACFB763, double 0x4021229B8CB8E087, double 0x4000A17EBAF10236, double 4.139580e-01, double 0x4018F5D0FA58F712, double 0x4015F2BBA98EDA23, double 0x4017C917939A7C18, double 0x4022DBC74FB549F9, double 0x4013A0A808C8259E, double 0x40050F0E0A84BE40, double 0x401A1FAA8A82A561, double 0x401CDCCC89B0EE4A, double 0x40214786E3B46FDF, double 0x3FF665EAAB042529], align 64
