module {
  ...
  llvm.mlir.global private constant @__constant_10x10xf64(dense<[[2.6808558541155012, 5.7225848280778422, 6.0914728652147563, 5.5902577459544647, 2.0519584571563465, 5.8078898413802023, 9.7801038180887616, 6.675816847721828, 8.0839805875639339, 3.8138009580072465], [5.3165595730082593, 8.8627605439690011, 1.5832784748915696, 5.9377100079992093, 9.9449122341456135, 3.0358315016780857, 4.567598924753149, 8.3619409446653812, 7.1413975699219465, 2.9445855999541468], [9.1242998579006578, 4.1615737871114522, 9.8801356402470581, 1.4615444428340862, 2.4909240809864484, 3.4797655246093493, 1.0109289011931666, 7.5227129737038023, 6.2104209941854505, 5.415063349674111], [4.6874947652773091, 8.7852857396712913, 5.1416585506036849, 9.653133237950799, 3.8129522584871447, 0.43307416507634144, 1.469579418626008, 5.0164493638336012, 7.0979456079131085, 0.051857415131744133], [6.3975240505323381, 5.4708167395759784, 6.6570448104523621, 9.3183529278254209, 4.3859470212365972, 1.4134797069456262, 7.9197483139570828, 1.6513853831235503, 5.2434112278442964, 5.1766082352903284], [4.6325628466377395, 7.5266565376228902, 8.6405202914251742, 7.713187491329899, 2.4900347568828196, 7.0427047925902411, 8.8229356407020028, 2.5107677319282717, 7.7694765350212975, 3.6809028420557754], [7.8483005596241622, 7.952601528068075, 7.0020155366618884, 9.2538270469221366, 8.9468581362582125, 4.3987063298767755, 4.3037607040470416, 9.1705241836271032, 7.0899345346314817, 0.46344228208524019], [9.3200061613944953, 5.0960945061944729, 7.9588201183502027, 1.5225796298986338, 3.7997572614954391, 8.1039936107745483, 0.91808865596309075, 7.004568159128989, 2.3567635401938603, 0.13239424598117222], [6.2573309795185352, 5.9016074792619087, 9.2219025766959817, 6.1570057390180661, 9.1920656827565317, 2.5247502806684476, 6.8276439012476606, 7.0522328019947018, 3.9924520344033532, 0.99093083857425101], [3.396186379335222, 4.8674886357856924, 9.8571264799506224, 6.2098552950145276, 1.0555827883038793, 9.9996464573106039, 5.7279272455187975, 3.3589632105929814, 5.8025239070993901, 9.6445633583194947]]> : tensor<10x10xf64>) {addr_space = 0 : i32, alignment = 64 : i64} : !llvm.array<10 x array<10 x f64>>
  llvm.mlir.global private constant @__constant_15xindex(dense<[0, 8, 2, 6, 8, 0, 4, 6, 8, 0, 4, 6, 2, 6, 8]> : tensor<15xindex>) {addr_space = 0 : i32, alignment = 64 : i64} : !llvm.array<15 x i64>
  llvm.mlir.global private constant @__constant_11xindex(dense<[0, 2, 2, 5, 5, 9, 9, 12, 12, 15, 15]> : tensor<11xindex>) {addr_space = 0 : i32, alignment = 64 : i64} : !llvm.array<11 x i64>
  llvm.mlir.global private constant @__constant_15xf64(dense<[5.5824280000000002, 1.487843, 9.0042980000000004, 7.2769959999999996, 3.964947, 5.2692480000000002, 4.6519130000000004, 6.6741489999999999, 9.8639139999999994, 1.518967, 2.8060710000000002, 7.4339380000000004, 4.4752460000000003, 1.673260e+00, 9.0753310000000003]> : tensor<15xf64>) {addr_space = 0 : i32, alignment = 64 : i64} : !llvm.array<15 x f64>
