...
@__constant_10x10xf64 = private constant [10 x [10 x double]] [[10 x double] [double 0x4021FE1CE21369FC, double 0x40207C8B709D556C, double 0x3FF75575DE5DD39F, double 0x40057FFA73FAF28A, double 0x4021C21E5EA84758, double 0x3FCDBEC55A19A0E0, double 0x3FD4449B0AB2C7B4, double 0x402137F4576D92D6, double 0x400BB4AAA2804498, double 0x40213154D5C469ED], [10 x double] [double 0x3FF40C2DE733FC2C, double 0x401F3F37C0A6B623, double 0x4000581222632E0E, double 0x40229E066660141B, double 0x4023B99428D28F59, double 0x3FECA889CADB81C0, double 0x401E6998A6957E99, double 0x4013A77608E4A721, double 0x3FE840313F04F52E, double 0x4005D43E88349EC4], [10 x double] [double 0x400AF490DE7AD225, double 0x4006AA53E48B5C42, double 0x4020CB08D2800701, double 0x4008AAABCE2BFD00, double 0x402160EEF27DAB3C, double 0x3FE740CBE261F99E, double 0x4012F2B1FDE0D050, double 0x4010A772D313B3C6, double 0x4006D6A1850719C6, double 0x4020405EACE4C366], [10 x double] [double 0x401103CF2391C988, double 0x400D33A888E97978, double 0x400B827A9861F575, double 0x40206F6E7E57A51A, double 0x401137BA8E698C24, double 0x4019615CFF349710, double 0x4010339486853482, double 0x401EEFBC4B6B61D6, double 0x401BC59AE2D60B08, double 0x400558C7E720905A], [10 x double] [double 0x402352B697002490, double 0x4017D42C52955C35, double 0x401DB684FD4CC770, double 0x3FF6DBF2CB6D0019, double 0x40227C1A1CEC94C0, double 0x40081BFBBF5AAD45, double 0x402279AA48880D64, double 0x4021313B5A3E2835, double 0x4013B4EFE530DC64, double 0x401970054D45E0BC], [10 x double] [double 0x3FFDAEF1EC9BE24F, double 0x4000C5A5F740F5F4, double 0x4016EFDED2B2AE7A, double 0x3FFBE65CBC66B410, double 0x40234E8B92CA5694, double 0x401CF591B3FE85F0, double 0x401CAF04FFF66231, double 0x4007638AFF35B3E9, double 0x4023E020D6B3E16B, double 0x3FE4141E936959E0], [10 x double] [double 0x3FED7F778EE794D6, double 0x400B92ACD19E31B8, double 0x401FE82F9DA31034, double 0x40233A3FD8F1F817, double 0x3FE77BC6B78B82A4, double 0x402362355FC63018, double 0x40097C34C408ADED, double 0x3FFD42941FFB2346, double 0x3FF5482A57458411, double 0x401CD8E84D560F40], [10 x double] [double 0x3FE3E370E1760A9A, double 0x40078FF15DD4B31D, double 0x401D3FEC3948EE6C, double 0x400AB9244D6EC61C, double 0x4012236A95DB2777, double 0x402099356D58F463, double 0x401A489664E2F8B3, double 0x4022444794D271FF, double 0x402246BABFBC7D16, double 0x4018B2B05DAE7AA6], [10 x double] [double 0x40231D2D3A2C1401, double 0x40011451424CA29E, double 0x4009FD53B6A8EC7E, double 0x4020DAC24D53B250, double 0x401E0119157357B6, double 0x4020F503B8644025, double 0x401825BA22866251, double 0x401F36D90BE008D1, double 0x3FFB28D2D9F5D107, double 0x401A5653C395F9BE], [10 x double] [double 0x3FFD62A844B6EFB5, double 0x4016D01D35807453, double 0x401C4A6C8E4C7E4A, double 0x4021BF9F9C5A16F0, double 0x4023946B897FE443, double 0x401321DF49D5B2A4, double 0x402150F0634BADB9, double 0x4012EA584785B8AA, double 0x401147DAA93F3AA4, double 0x401F3938FC6D33C2]], align 64
@__constant_35xindex = private constant [35 x i64] [i64 3, i64 6, i64 7, i64 8, i64 9, i64 3, i64 6, i64 7, i64 9, i64 0, i64 4, i64 6, i64 7, i64 9, i64 7, i64 2, i64 4, i64 1, i64 2, i64 5, i64 0, i64 1, i64 2, i64 1, i64 2, i64 3, i64 6, i64 9, i64 2, i64 4, i64 7, i64 1, i64 2, i64 6, i64 8], align 64
@__constant_11xindex = private constant [11 x i64] [i64 0, i64 5, i64 9, i64 14, i64 15, i64 17, i64 20, i64 23, i64 28, i64 31, i64 35], align 64
@__constant_35xf64 = private constant [35 x double] [double 2.798590e-01, double 0x4004CA5614DF8B15, double 7.819000e-01, double 9.328260e-01, double 7.607120e-01, double 0x4019FCAB81F969E4, double 0x402093A5A038194C, double 8.029050e+00, double 0x3FF0DDF97AAAC109, double 0x4022E0CE703AFB7F, double 0x402334BA30121683, double 0x401E8C1F85D744F6, double 7.883580e-01, double 0x4020A44F1A1986BA, double 0x401AC22A2C237479, double 0x40204D564B662FE0, double 0x401E534699418506, double 0x402121BD8383AD9F, double 1.183860e+00, double 0x401BFD8B1DD5D3DD, double 0x4016E3558A761028, double 0x4016A36EF8055FBB, double 0x4001CBD76EE73E68, double 0x401714690DE09353, double 0x402350157EED45E9, double 0x40158DE8F6CEFED6, double 0x401389F98B71B8AA, double 0x40138B0079A2834D, double 0x40225034F3FD933E, double 0x4021D9B10FD7E458, double 0x4022FD1F3E89A88B, double 0x402180A47ECFE9B8, double 0x40209368CEF672B9, double 0x40224FD566CF41F2, double 0x3FF7A845996744B3], align 64
