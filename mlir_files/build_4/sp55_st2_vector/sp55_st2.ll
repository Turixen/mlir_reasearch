...
@__constant_10x10xf64 = private constant [10 x [10 x double]] [[10 x double] [double 0x40154BC7D2A72F4E, double 0x3FE720EE187B451A, double 0x4012BEC44E276A61, double 0x400ACF0A9FC70D51, double 0x40171A8272B03394, double 0x401382A64390A562, double 0x400329AFDA7A53FC, double 0x401383708E599ADE, double 0x40167133A307523A, double 0x3FBFC8BB4B3A9A00], [10 x double] [double 0x40207292B710FE2E, double 0x40225AB02F173469, double 0x4016AA620776B1E6, double 0x40204DE146BA24B6, double 0x402234AFCEEA2067, double 0x40197CC1632C5F8E, double 0x400FC96B17D49052, double 0x401732CA51AFA81B, double 0x400C1CDF8F78E59C, double 0x3FF97962C446F082], [10 x double] [double 0x3FE8DCC7A0F30F0E, double 0x40231AA39A542A9C, double 0x3FF21F3527C46741, double 0x3FCF67148F38B880, double 0x4015C23D7765702C, double 0x401C40CBDFDEAC58, double 0x40161058E50CF369, double 0x40168BC103860139, double 0x401870E2E4A709CD, double 0x401B749D0608FFA8], [10 x double] [double 0x4018D7C0F8291332, double 0x3FF4CAE6DA04689D, double 0x40159EBBAAD3A1C4, double 0x4022FA3A882AD439, double 0x40221FD720D1F68A, double 0x4022211DC45A1E39, double 0x4013AD3D60B3ECDC, double 0x401124807AB64DA4, double 0x401185BBDEE6D19E, double 0x3FF1F968BDFC5653], [10 x double] [double 0x4000AAC60B03AE0A, double 0x402152A81F2B95A3, double 0x4008088C77ABF5DF, double 0x3FFC3D5D3268E5D7, double 0x3FFBE0E7E78AEFB4, double 0x4022728BD4483FD0, double 0x40222BDC46FD550F, double 0x40211EE44FACF131, double 0x401DE526BF74E0B6, double 0x40229E1A4850245D], [10 x double] [double 0x400375BB9EE78B04, double 0x3FF0BA5F4176E42A, double 0x401748FB09F1FFD1, double 0x4022818D4AD5A4A8, double 0x4014BD6E18A44D57, double 0x4016779ECA04BCAB, double 0x4023DEC467D84112, double 0x3FFCAE35B6A862E8, double 0x401FDC73386FA864, double 0x4019AFCE8B88448D], [10 x double] [double 0x3FD53229FBF2D778, double 0x40215CB78F1A1A5D, double 0x401F8F63B96EE01B, double 0x3FE3845174FE709C, double 0x40058F038DC236A6, double 0x4013D872AFC447D6, double 0x4014C1557BCEE7A8, double 0x40069F704646C866, double 0x4023BCEFC877F028, double 0x401110A6F796C283], [10 x double] [double 0x3FF13EBA8F62F5A9, double 0x3FFBFD12FBC54CC1, double 0x4007B1BEACA2E82C, double 0x4021D906682F2481, double 0x40192ED29571AAB5, double 0x40128ADF0B18D2A6, double 0x40164E65573FFF4B, double 0x4018D48460E96873, double 0x401D482F28C8B908, double 0x401B3EDB13BA6465], [10 x double] [double 0x40218B7F44E3D4EF, double 0x40137664E7426912, double 0x3FD8564EBEE693DC, double 0x4007EF20DD935FB4, double 0x40216FD93CED9CBA, double 0x4021403D908A076E, double 0x3FDAEFE447F83B54, double 0x4021DFC0F447D926, double 0x40211DEFA76FDC74, double 0x4017E306B92093D0], [10 x double] [double 0x401D7C35E29EE8CC, double 0x3FF2CD250C09DF74, double 0x4018C8A887D8BF6F, double 0x3FD010EB37BC4EE8, double 0x4017E53E1DF2330D, double 0x3FF498800F37349E, double 0x402034C0EDDA0188, double 0x4011BCAF7E36758C, double 0x401EBB42A981548B, double 0x3FD05C9621FD8ECC]], align 64
@__constant_45xindex = private constant [45 x i64] [i64 0, i64 2, i64 4, i64 6, i64 8, i64 7, i64 8, i64 0, i64 1, i64 2, i64 4, i64 6, i64 8, i64 6, i64 8, i64 0, i64 2, i64 4, i64 6, i64 8, i64 0, i64 3, i64 6, i64 8, i64 0, i64 2, i64 3, i64 4, i64 6, i64 8, i64 2, i64 3, i64 5, i64 0, i64 2, i64 3, i64 4, i64 6, i64 8, i64 3, i64 4, i64 5, i64 6, i64 8, i64 9], align 64
@__constant_11xindex = private constant [11 x i64] [i64 0, i64 5, i64 7, i64 13, i64 15, i64 20, i64 24, i64 30, i64 33, i64 39, i64 45], align 64
@__constant_45xf64 = private constant [45 x double] [double 2.635350e+00, double 4.768350e-01, double 9.345050e+00, double 0x401D1392E1EF73C1, double 0x400177E4DE3B8A1A, double 0x40194974A3400B89, double 0x4005BDBCA9691A76, double 0x401BC3B60285EC3E, double 0x40146B10BA6266FD, double 0x40202AB5E529BAE4, double 0x4020928027D88C1E, double 0x4002DC51DABE2718, double 0x400100D801B43526, double 0x402334E54F7A9197, double 0x400389068986FCDF, double 9.216960e+00, double 0x4012CB9AE0C17657, double 2.663860e-01, double 0x4022FE7903211CB0, double 7.767500e-02, double 0x400A252CE032DB1F, double 0x400560346DC5D639, double 0x401CF4E4430B178B, double 0x40100C15097C8084, double 0x4013FC9EA9A3D2D8, double 0x401E72F09D8C6D61, double 0x40110B9884C6A3BE, double 0x40083F0B28522EA1, double 1.747520e-01, double 0x401E421A719B4DCF, double 0x3FFA9BC44BF4CB19, double 4.972220e+00, double 0x40191236C15D2D02, double 0x40205B2D0A244630, double 0x402367AB10BA6267, double 0x40191963992C8C50, double 0x400DECCFF21B3AEF, double 0x4018D2CCB3A2595C, double 2.417510e+00, double 0x40093D92B7FE08AF, double 0x4008C1049235F80A, double 0x4006E0CCFF21B3AF, double 4.798940e+00, double 6.993480e-01, double 0x400A47F90D9D7775], align 64
