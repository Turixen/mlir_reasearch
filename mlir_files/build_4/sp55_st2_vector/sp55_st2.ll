...
@__constant_10x10xf64 = private constant [10 x [10 x double]] [[10 x double] [double 0x40231C3FF4887471, double 0x401FCEB2554A71C7, double 0x400FA02677F78769, double 0x3FFDF970244E501A, double 0x401398E6407D761E, double 0x4020205751D6C1A8, double 0x3FF78065418DEA6C, double 0x4021FE4820FCEFA0, double 0x4016629343B353DB, double 0x401CEEBBC21A7041], [10 x double] [double 0x4020BE51CCB018B5, double 0x3FE7C5284DE61098, double 0x4015FAC6309E5098, double 0x401015124A7ECE77, double 0x400007227C268A17, double 0x3FC283F2AD4A53B8, double 0x4010E25EC1E88979, double 0x4023410B378FAE7A, double 0x3FE4045986225572, double 0x40161950120E8734], [10 x double] [double 0x400C81681421373A, double 0x4021EDD619C206BB, double 0x401F9320868571D7, double 0x401424CE1A39DA42, double 0x40100ECA8BA8F752, double 0x3FF231FBD6A8189C, double 0x401793A2864AC103, double 0x4018F9103DEF7024, double 0x400E71EC2566EE2E, double 0x4010706461137FB9], [10 x double] [double 0x4020976EFEB9A245, double 0x3FFE5A6ABCACB887, double 0x4014487489C58A05, double 0x4008FEEC9DC59ADA, double 0x4013C6427E49FD97, double 0x4021426DB12CE711, double 0x401C73B5061E0937, double 0x4012C23BBD88CDA6, double 0x401361010EDBAF5F, double 0x4001948E4869FB7D], [10 x double] [double 0x400B5EF4613EBA94, double 0x400CDB818A78679C, double 0x40068BEC03DD092D, double 0x401B1CDEDBDA9632, double 0x3F97F1FCB5FFF1C0, double 0x3FF30B69446D7600, double 0x400DB134AF8A0360, double 0x400C05455B1FF425, double 0x4019CC79A4D469CC, double 0x402082937DCBE764], [10 x double] [double 0x40208D44D19B6A2A, double 0x4012338126830E72, double 0x4001148C88CFB926, double 0x3F4EFA01F1229000, double 0x4018FB45D6F07C5C, double 0x401474862B296BD5, double 0x401DB056A76F481E, double 0x4020EE3744093E4F, double 0x40216FEC9578FDF1, double 0x4020F83EBE3A758E], [10 x double] [double 0x4023E3FA5C9DB707, double 0x4005D560E37DF5D0, double 0x4015CCBB5DCA0CF5, double 0x4018439A3B214F5F, double 0x3FEDD492ACC03BD2, double 0x401EEE6C80703DFE, double 0x4008847063D15862, double 0x3FFAA565C5114965, double 0x401E19FD713927C7, double 0x401B44B9691F621E], [10 x double] [double 0x40209B9368CCDEEB, double 0x4019457B0870E4AB, double 0x4010253C0E669872, double 0x4014AE5F86F675D2, double 0x401AEFEC9B5381B1, double 0x401BD03743BBB479, double 0x4022780314B44FCA, double 0x400126866E184B00, double 0x40237DCB0AF7AA28, double 0x3FEABE1E81C0B0AC], [10 x double] [double 0x3FB4B0AF64398860, double 0x40110A939303B4C9, double 0x4019AACE00F66693, double 0x4023DD4FB62B85DC, double 0x401B6D837623E645, double 0x400724A6648A0FE3, double 0x402146CE9FF6212A, double 0x40070C04F2FB8FC8, double 0x4016011D96CEBA11, double 0x3FF1B32CD9671A86], [10 x double] [double 0x4013211E3F84EB7E, double 0x3FDDE273BC9693DC, double 0x401580B76573F74A, double 0x401A34654ECD7890, double 0x4021DA91FC777754, double 0x4004B338F9C533C4, double 0x4013C6921D872C76, double 0x401DE08C1FB116B0, double 0x402023E378044EDB, double 0x3FFD9E295E3EAB64]], align 64
@__constant_45xindex = private constant [45 x i64] [i64 0, i64 2, i64 4, i64 6, i64 8, i64 4, i64 0, i64 2, i64 4, i64 5, i64 6, i64 7, i64 8, i64 0, i64 2, i64 4, i64 5, i64 6, i64 7, i64 8, i64 9, i64 7, i64 0, i64 2, i64 3, i64 4, i64 5, i64 6, i64 7, i64 8, i64 0, i64 1, i64 5, i64 0, i64 2, i64 3, i64 4, i64 5, i64 6, i64 8, i64 9, i64 1, i64 5, i64 6, i64 8], align 64
@__constant_11xindex = private constant [11 x i64] [i64 0, i64 5, i64 6, i64 13, i64 13, i64 21, i64 22, i64 30, i64 33, i64 41, i64 45], align 64
@__constant_45xf64 = private constant [45 x double] [double 2.290130e-01, double 0x400459DBA908A266, double 0x40221F2D5E071C54, double 0x4003FA26A22B3893, double 0x401765DD8F92AF9B, double 0x400A7FEDA6612839, double 0x3FB97A355043E532, double 9.374560e-01, double 0x401336861E92923E, double 0x401A50D349BE8FF3, double 0x400EA18D6909AED5, double 9.507660e-01, double 0x400DE310DBF0563F, double 9.114960e-01, double 7.098700e-02, double 5.938280e-01, double 3.151010e-01, double 0x400C74B9CB6848BF, double 2.728700e-01, double 0x401F41733226C3B9, double 0x40194752DA98676A, double 0x4021BC5BD0E12E84, double 0x4023709A02752546, double 0x40101D8F0C77DD87, double 0x401B0272C94B380D, double 0x40223E931876188B, double 0x4015458BC59B8024, double 0x4020485F6BA0620B, double 0x4004DE37585BE1A8, double 0x402349528F190D17, double 0x4016990D5A5B9629, double 0x40108AA3F034B0E2, double 0x401B02AD3E920C07, double 0x4008515B573EAB36, double 0x400E6812BE48A58B, double 4.004990e+00, double 0x401D730CAA326E11, double 0x3FEE33C3E74AFD54, double 0x4019F20AB7132724, double 0x3FFCFA16E7A311E8, double 0x3FF2855FBB517A46, double 0x40148C6B05319829, double 0x400B9171E29B6B2B, double 0x401084406C00DA1B, double 0x4021F3D7D3910C2C], align 64
