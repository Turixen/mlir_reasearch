...
@__constant_10x10xf64 = private constant [10 x [10 x double]] [[10 x double] [double 0x401D995A3AE4520A, double 0x4023C2E33CEE44E1, double 0x401591F5476C15F5, double 0x3FF5796439A1D94E, double 0x40228366C7ECC9F0, double 0x40049E05C0ECC6BA, double 0x3FEB8030022DBC0C, double 0x402328ED1E8428C2, double 0x400C81A122E062E7, double 0x4016C383564D114E], [10 x double] [double 0x400A4CAA19F640CE, double 0x401C78AB40B4FD9C, double 0x400B3D134628E21B, double 0x3FEC95BB96C9C8BE, double 0x40210263B1F88D19, double 0x4004185E9BC76E78, double 0x4019C1FDA5CAC617, double 0x40108EB2F3BDB425, double 0x400AA07D0C14D734, double 0x40103D6FA2869C5B], [10 x double] [double 0x4015A06AC6CCF5D8, double 0x4022CD9690B16B87, double 0x40172E0EE825E5BD, double 0x40131BCD80608565, double 0x401AE8AB7322056A, double 0x40206AD81AB1810F, double 0x402315BC1387AD71, double 0x4002322E6E91BF30, double 0x4004F7C38B22C894, double 0x40196D67D51C6208], [10 x double] [double 0x40161A74464A8EE1, double 0x4012639C9A015931, double 0x4023D8B39C432884, double 0x400A53F82346C3F3, double 0x402001234853E517, double 0x401E4567BFD518B5, double 0x4012E92D7C117ABA, double 0x40236DF883B8C07C, double 0x40118E6DD2D1E2F3, double 0x3FF5CFC6F98B5259], [10 x double] [double 0x4015DC7DC65B2CF6, double 0x3FF5429269199279, double 0x400E1FB01AD88332, double 0x4017A9357500C840, double 0x4014C6029C6E87FA, double 0x401623DF6E3C62B4, double 0x401E0504C602D283, double 0x4017571C27CD2371, double 0x40209B08BA5666EE, double 0x402204F0152DC008], [10 x double] [double 0x400033B55FEDFF2D, double 0x4020D4727FA056EA, double 0x40069071757CE0B0, double 0x3FF5BC27471952EA, double 0x401819A14BA0246A, double 0x401402517A2B90F0, double 0x4021610867D14DB1, double 0x401EB03424F43310, double 0x401D8F7F517C8F0E, double 0x4022CC2A78774808], [10 x double] [double 0x40205902172B12BE, double 0x3FF56BFCF34057D3, double 0x401E6BD69AD6D0D5, double 0x402320A79194F832, double 0x4013A3093E423972, double 0x40106E0D12DB70E7, double 0x40163263DCBF7B15, double 0x401CBC68EE4419FC, double 0x4020E37819366D22, double 0x3FF1C3D92E479FB9], [10 x double] [double 0x4006974A9E3036F8, double 0x401E3EE54323A86C, double 0x3FF4707DD77030B7, double 0x40041A617F1CEB50, double 0x4021AC91A4ADBD2A, double 0x401C92CD06190893, double 0x402304676840761D, double 0x3FF3E120044F1118, double 0x3FF0B9D3BD3E684E, double 0x401FA62BABF61599], [10 x double] [double 0x4014299FF472C56E, double 0x401F56B0C96E8D56, double 0x401BD799935629F0, double 0x40053B48AE87AB08, double 0x4003F097B01CE59A, double 0x4010310ED3C154B4, double 0x401EFBC4150AE386, double 0x401A773F7FE53E18, double 0x4021BBB03AAAAA3E, double 0x4021491947F2ABB8], [10 x double] [double 0x3FF8F966B7AE1AC5, double 0x3FF8690EE6B9ACB9, double 0x402051266D26429C, double 0x40217ADADA352ACE, double 0x40220D2450348A0C, double 0x4017CBCE805B16BF, double 0x401ECCDE26900D20, double 0x3FEC7842648BEF44, double 0x400693F0BEF09A1B, double 0x4014C88177977426]], align 64
@__constant_35xindex = private constant [35 x i64] [i64 0, i64 3, i64 4, i64 6, i64 9, i64 4, i64 1, i64 0, i64 2, i64 3, i64 4, i64 6, i64 9, i64 5, i64 2, i64 0, i64 3, i64 6, i64 7, i64 8, i64 9, i64 0, i64 2, i64 3, i64 5, i64 1, i64 4, i64 7, i64 0, i64 1, i64 3, i64 4, i64 6, i64 7, i64 9], align 64
@__constant_11xindex = private constant [11 x i64] [i64 0, i64 5, i64 6, i64 7, i64 13, i64 14, i64 15, i64 21, i64 25, i64 28, i64 35], align 64
@__constant_35xf64 = private constant [35 x double] [double 0x40176CBFF47735C2, double 0x4010E9EA14057082, double 0x4016F050374FF866, double 0x3FF5774DDF86E3B4, double 0x402087E154434E33, double 0x400A6096787CE960, double 6.071740e+00, double 0x401F82ABEF06B378, double 0x4020086B9C304CCF, double 0x400F22E90364388F, double 0x4022D2EDDCE7CD03, double 0x40100C5E6FF7DFA0, double 6.989480e-01, double 0x40236F607C4199FE, double 0x4011A693C03BC4D2, double 0x40133C436FC158FB, double 0x40157B35B0BBF50E, double 0x4001ED39DA16616B, double 0x4022D9F77292C493, double 3.090520e-01, double 0x4016159253543AEB, double 0x40225405F6BA0621, double 0x4021477E3D1CC101, double 0x401A39884C6A3BDE, double 0x40220D29563A9F38, double 0x401DFD6909AED56B, double 9.663700e+00, double 0x400ABE35C5B4AA97, double 0x4008315CE9E5E248, double 0x401DB938151A4378, double 0x400EBFD47BEDB728, double 6.361730e+00, double 0x402366C3547E0696, double 0x400861BD1ED9DFDB, double 0x402199B6F5CAF2D8], align 64
