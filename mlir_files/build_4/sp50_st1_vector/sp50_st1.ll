...
@__constant_10x10xf64 = private constant [10 x [10 x double]] [[10 x double] [double 0x4013EC9270B69915, double 0x4022B4DD3AC8375C, double 0x4016F3CCBAE46F93, double 0x402373A642072491, double 0x401FD1471D8FA335, double 0x4012508446A780F1, double 0x4005C65FF831B4EA, double 0x401370C039B0B987, double 0x4006AED687FDA1E0, double 0x40128F0BA9AD5BC8], [10 x double] [double 0x40219205D52D3CCE, double 0x401493E69B0A0EE2, double 0x401982F9ADF9F292, double 0x3FFD682B628D8AF2, double 0x401D95D2ABF7D4BA, double 0x40122B0EA1BDC62F, double 0x40122AC88B758DC2, double 0x40223C7651BDF9D5, double 0x40233EB620A80230, double 0x3FED3ADDC26E1156], [10 x double] [double 0x401B0AE34AC8424C, double 0x401958A013D5CCB4, double 0x401E3EDEC95ADF4A, double 0x401421F1B922C892, double 0x40225C061C393AA0, double 0x3FF2AE2EA7639980, double 0x401916B7275C314A, double 0x40041F07902540A2, double 0x402245796CD5E746, double 0x401D68DF396B5FA1], [10 x double] [double 0x4000185F1DD2F7A9, double 0x401858D36E619088, double 0x4022916A21FC81D3, double 0x4000E01BCA0E061C, double 0x4017A9F953D124B0, double 0x3FEFF51079B030D0, double 0x402242ED2881EDB1, double 0x3FFD696690365BDC, double 0x3FD71A654ED1BEF8, double 0x4021B293CB83C18A], [10 x double] [double 0x401083C1DB91720C, double 0x401789F5DDDA17DF, double 0x4023216B8221BC65, double 0x400E2F760B272B7F, double 0x40214F446899C912, double 0x40133B8D1FD8102A, double 0x4017248F5A6FD66B, double 0x40077070CAA14489, double 0x40027EA2A10B4F26, double 0x40163DABBBAA5819], [10 x double] [double 0x401919FAE2DAF4C1, double 0x40082496592D0234, double 0x401D87C5EF347D4E, double 0x40109AD8E23A0A9E, double 0x4018C0A367A442C8, double 0x4000CC39B793FED8, double 0x40206A5D8DD21DAB, double 0x3FE23F421C19922C, double 0x3FAB56D318C3CDC0, double 0x40218333520EE0AB], [10 x double] [double 0x40209AD98059462B, double 0x400DB23C08921062, double 0x4021B45C729A65E9, double 0x3FF3A86A18133F6F, double 0x400B3CF7EB83E45A, double 0x401D393B17A00D46, double 0x4022D389A1E3A4CA, double 0x3FF2AF4413502DC8, double 0x3FF69CE53BA743A5, double 0x40207075735CC520], [10 x double] [double 0x401456A2266E8626, double 0x400AE5910228E14C, double 0x3FF83A5B5340903D, double 0x401D0F42A87F003E, double 0x3FEB4480AAEA3C62, double 0x401C3F8F1CF86AD0, double 0x40107534C259DBB1, double 0x400E2CE1219E1C34, double 0x401835FA13D4E025, double 0x402235FF021774C8], [10 x double] [double 0x40217360707C612A, double 0x40065F12CFEE5CAD, double 0x3FED40A338BCBF4A, double 0x4012AA6D16DB8750, double 0x40213E743341A8BD, double 0x400B009F8AAF4888, double 0x4017CBE465D58304, double 0x3FF553593F383A1E, double 0x40139F0EDB9B1336, double 0x40167D5E4266527E], [10 x double] [double 0x4022E32B8206E2BF, double 0x400C7BFF1B34B4E4, double 0x401F245953BB3CAE, double 0x3FD7F08C7CD9E598, double 0x3FF4A882751E454C, double 0x401D7ABA57063C42, double 0x4011E1C16ECE65BE, double 0x401218B4286E3832, double 0x400B1BD33259C7C5, double 0x3FFD8DE1725EC2DA]], align 64
@__constant_50xindex = private constant [50 x i64] [i64 0, i64 1, i64 2, i64 4, i64 6, i64 8, i64 9, i64 0, i64 3, i64 4, i64 9, i64 3, i64 6, i64 8, i64 9, i64 1, i64 2, i64 4, i64 5, i64 6, i64 7, i64 9, i64 0, i64 3, i64 4, i64 1, i64 6, i64 0, i64 3, i64 4, i64 5, i64 6, i64 7, i64 8, i64 9, i64 0, i64 1, i64 2, i64 3, i64 4, i64 6, i64 0, i64 2, i64 6, i64 7, i64 9, i64 2, i64 3, i64 5, i64 6], align 64
@__constant_11xindex = private constant [11 x i64] [i64 0, i64 7, i64 11, i64 15, i64 22, i64 25, i64 27, i64 35, i64 41, i64 46, i64 50], align 64
@__constant_50xf64 = private constant [50 x double] [double 0x4021339170D62BF1, double 0x4016774D594F26AF, double 0x402240C154C985F0, double 0x4015921BC126A65D, double 0x400BDBFDF7E8038A, double 0x3FFA99934EFCBD55, double 0x401F97E02645E4E7, double 0x4023C0A19C9D5A18, double 0x4022F745E0B4E11E, double 0x400EBE9FADAFD114, double 0x401D664388EBCC6C, double 0x401A583B1D0C8041, double 0x401FC5810624DD2F, double 6.550580e-01, double 0x401A5D6909AED56B, double 5.699310e-01, double 0x4016894C87980F56, double 0x3FF4DA0168B5CBFF, double 0x400ECB3CC4AC6CDB, double 1.278800e-01, double 0x400891A5CA29845E, double 0x401E738476F2A5A4, double 0x4022E4DC22AB25B3, double 0x40104D15F02C4D66, double 0x401523F4666EC9E2, double 0x4006FF266BA493C9, double 0x40118119CE075F70, double 0x40150EAF6837F7BE, double 0x402110C4588A04D1, double 0x400A578F68BE2F7B, double 0x40114EAE5BC87DB3, double 0x40222D0F6273929F, double 1.876880e-01, double 0x402085ABC0E38A7E, double 6.669790e+00, double 0x4000217763E4ABE7, double 0x40216184E3FFEF39, double 0x4000BA52263D816B, double 0x401788CFBFC6540D, double 0x400C58A222D5171E, double 0x40176D30F062D40B, double 0x4022A5FDCDF69878, double 0x401941B0468448CF, double 0x401EE601797CC3A0, double 3.015490e-01, double 0x40219D810624DD2F, double 0x4020940D4DC65C70, double 0x4018A6CB5350092D, double 6.552900e+00, double 0x401270574B407033], align 64
