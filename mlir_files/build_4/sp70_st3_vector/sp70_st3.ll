...
@__constant_10x10xf64 = private constant [10 x [10 x double]] [[10 x double] [double 0x40099A7FE8B577BB, double 0x401F5EC49BB1AD98, double 0x3FE156E50F689C12, double 0x400A9A79AE2CFAE4, double 0x4012F26C94A4F045, double 0x4022CFA8C21BE6BC, double 0x400FDA811A275000, double 0x40222850D16E6108, double 0x4020E483FA2ED177, double 0x40040B1C0F5A3CD6], [10 x double] [double 0x4005EF7E3B83CC1E, double 0x4021460BE9C7A330, double 0x401D62F9BC81588C, double 0x40056CE38981B07F, double 0x40105D3A358E4CF1, double 0x400DFFAD91C83901, double 0x4022A78C49213050, double 0x3FFAF73F631B12BE, double 0x4011B6B2142106F4, double 0x401DA833E5574512], [10 x double] [double 0x401F695D8A99C95F, double 0x3FD581A37CD29FA4, double 0x40102245E788ED84, double 0x401EB1302DD5445F, double 0x400BF35A2A8409F4, double 0x4006754A42573418, double 0x4017A6B55F58385C, double 0x3FF16B65B8218541, double 0x4014773C2F3948FA, double 0x4001B678BD2F8994], [10 x double] [double 0x4023032DDD829256, double 0x401D47206F43EDC2, double 0x40039CFADF46AABE, double 0x40128E2DB46E8FD9, double 0x4002833BCE66A2BB, double 0x3FFB5A5075156B21, double 0x400252D98E3C2072, double 0x4022E03D8744FD2D, double 0x400BDA9BBD63277B, double 0x401444F03AF27994], [10 x double] [double 0x3FCA3B93129A2630, double 0x4008D948B756DD96, double 0x3FF407F37F1312B0, double 0x40145C5B52B34DE9, double 0x4022E32FE0D869D9, double 0x3FF1D3D8E5D0450A, double 0x402039B7972AE2B3, double 0x4013888679C84482, double 0x4011380DB73187F6, double 0x3FDF75E22ACB1C6C], [10 x double] [double 0x4023EA23AFB41D32, double 0x4023DFE516CFA549, double 0x4002B1B6B0F02F20, double 0x400CE2CBD8CC1BD3, double 0x3FF65BFC7712A6D4, double 0x401724B7C33B7726, double 0x3FDCB99BF6C878C4, double 0x40153DEF6A54280E, double 0x4019DDD5AD08A207, double 0x401B81CC8EA0B644], [10 x double] [double 0x401ED0138B0999FE, double 0x4004DE2A9D1CDA5D, double 0x40133C75BC69F486, double 0x40193985CC69A2F6, double 0x40231BC098632E0B, double 0x3FC7ED5FFE4BD530, double 0x401C136A1AFC968F, double 0x4017ED9761047260, double 0x3FE1446F6D554326, double 0x3FE9F08C5EB5E29A], [10 x double] [double 0x40210CCDCA765939, double 0x3FE9A3E56D71BF00, double 0x401A5EB49D6DB575, double 0x401687C10900AA43, double 0x40011E9CFAB6A9BF, double 0x40166A98A9199939, double 0x401E3E07267A6AE0, double 0x401340F400276C34, double 0x40224B50677DB267, double 0x402257B80BB64485], [10 x double] [double 0x401B3629B0C22C45, double 0x3FF93CB3CA057002, double 0x3FFA7D954A646951, double 0x40223318780F68AC, double 0x4017B5CAEDA5AAF1, double 0x4022443292FE526A, double 0x401D85AF50E68C39, double 0x401FBA545126A211, double 0x3FD611189C9A6510, double 0x4013265898BAE3DE], [10 x double] [double 0x401840A7F7028A80, double 0x401DBFF8830AE062, double 0x402006E820776AF0, double 0x400FD575AA05BE09, double 0x401C2E6A20B7BA1A, double 0x400E1029A451E1BA, double 0x3FD0CDF74A8E3FF8, double 0x3FD55D37458AC3CC, double 0x401819DDB6919E4B, double 0x3FED1EB8643628BC]], align 64
@__constant_30xindex = private constant [30 x i64] [i64 0, i64 1, i64 2, i64 3, i64 6, i64 9, i64 2, i64 6, i64 5, i64 8, i64 0, i64 3, i64 4, i64 5, i64 6, i64 9, i64 1, i64 3, i64 4, i64 0, i64 3, i64 6, i64 9, i64 9, i64 1, i64 5, i64 0, i64 3, i64 6, i64 9], align 64
@__constant_11xindex = private constant [11 x i64] [i64 0, i64 6, i64 8, i64 10, i64 16, i64 16, i64 19, i64 23, i64 24, i64 26, i64 30], align 64
@__constant_30xf64 = private constant [30 x double] [double 0x401AF73365881A15, double 0x401127EFE0CE0B91, double 1.650610e-01, double 0x401413F4ECA686E8, double 0x4016AEB5F5F0B285, double 0x3FFC3CBD556084A5, double 0x40119539B888722A, double 0x40116DE093532E7B, double 0x3FF3E603D577963A, double 0x402111EC0B567558, double 0x401DCDF090F733A9, double 0x40005EDF1E0828C3, double 0x4006957C4E2F37FC, double 0x4005FA89331A08C0, double 0x4010BE3193F6C26A, double 0x401CE6EF3D3A1D32, double 0x40114011D3671AC1, double 0x401FFD13D74D594F, double 0x3FEFA3AAFFF36AC6, double 0x40152787485E3DA3, double 0x400B563FDD65A145, double 0x40219F70DE8F6CF0, double 0x4021350D49949E88, double 0x4021F06FAC6045BB, double 0x401B81016CE789E7, double 0x40233AAD81ADEA89, double 2.198700e+00, double 0x40236B471F79420B, double 1.230890e-01, double 0x40163B58D1526D8B], align 64
