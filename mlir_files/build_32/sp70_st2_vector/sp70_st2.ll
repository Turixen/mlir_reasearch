...
@__constant_10x10xf64 = private constant [10 x [10 x double]] [[10 x double] [double 0x3FCE73B799ADF6A0, double 0x40225664891DC705, double 0x4013B864A80EC4CA, double 0x4023DE2F4105D0F5, double 0x400AB32110BFEB26, double 0x400289F9CC9E03E7, double 0x3FD9B862230A8C08, double 0x40223E820E112762, double 0x3FE6D903EEF9B35C, double 0x40203EFBA55DBEDB], [10 x double] [double 0x4012B9630AC5F835, double 0x401C0EECFCAAF442, double 0x40214DFCF2A977A6, double 0x4023C6A6F61E727B, double 0x4013C9D71E9847A2, double 0x401F7CA2F42B98E8, double 0x40203A3E04DFEB3A, double 0x3FE1428C3BB83D80, double 0x4005BDE9DCB27845, double 0x3FE08F17E1161AB4], [10 x double] [double 0x40153ED98740D0C5, double 0x4023C86B644BE90D, double 0x3FFF860B2A322B31, double 0x40015E22B7F03F13, double 0x4022B8BE2D053D79, double 0x401154469DAD43C1, double 0x401F8E968FF3B059, double 0x3FFE6BB1A2D719FE, double 0x3FF24E578168BC97, double 0x402109CAFE711BB6], [10 x double] [double 0x4021D84DDF497AC9, double 0x401103C00399784E, double 0x400798214AB916D3, double 0x40182A46253E6034, double 0x4017799B679C91EE, double 0x4019C21B6C883887, double 0x401DB811769B287E, double 0x40043D56FFB6A66E, double 0x4005B0BE79F0E477, double 0x401F05F4A94CFE39], [10 x double] [double 0x401BFF6BE39FE99D, double 0x4001ECCF08EF659A, double 0x40131780EB74C540, double 0x4010231422E26A16, double 0x3FFC68ACF417088D, double 0x3FE7A263B0F685CE, double 0x3FF5D30516BD0AD4, double 0x401B8FE494321082, double 0x3FEDE90E159CD3E2, double 0x40046C14587E9C78], [10 x double] [double 0x4012203893E5EFE1, double 0x401567469E40F3B1, double 0x40203C3873B3412A, double 0x3FE73A42D369A4B2, double 0x401030109C35D17C, double 0x401AB947D41A9CB6, double 0x3FF8C43DD194CFCD, double 0x4017915E18CCB858, double 0x401C44DB0FB92C28, double 0x401481022F489038], [10 x double] [double 0x3FD9A1FAE859EE50, double 0x40028982C0283FDC, double 0x4012C965994CC685, double 0x3FFCF9CA46377ABD, double 0x401CC19313EB677E, double 0x401B55385AE58EFC, double 0x3FF66447CDE4DCB3, double 0x401251A8E81AAB05, double 0x4015A2A28D28B9A6, double 0x3FFA1ADD6AC2FE9E], [10 x double] [double 0x3FF48ED3FFF267C5, double 0x3FD28FC69E51B63C, double 0x401BAC001A1C4A89, double 0x4023D95E1B804087, double 0x400601E8EF196F00, double 0x401EE00DE3CF97E8, double 0x401CA86BEDF3053A, double 0x401E1A4B2FC67CAA, double 0x401938C1C88A0878, double 0x401D96A8BE96AE3C], [10 x double] [double 0x4019B9B779B8FA49, double 0x401317556C06E833, double 0x4002D855CB17B72C, double 0x40109A7D6B609BA6, double 0x4016C4E49CE34015, double 0x401995FE703A20AB, double 0x400348650B261A28, double 0x401C4CC49967254C, double 0x40077E8E6B3169A0, double 0x3FEF41FDCEF6AA2C], [10 x double] [double 0x4022074CBFAF2AC1, double 0x400D0CF3D3F959ED, double 0x4022AF01C378757B, double 0x401B2E56BCCFAD18, double 0x4017ECBA9B4CF360, double 0x40049AC54FBB7404, double 0x400394EF7C393390, double 0x400AC14BBDCB3268, double 0x402309B31AFB1FE7, double 0x3FC95D81FEDF2EF0]], align 64
@__constant_30xindex = private constant [30 x i64] [i64 0, i64 2, i64 4, i64 6, i64 8, i64 0, i64 2, i64 4, i64 6, i64 8, i64 0, i64 0, i64 2, i64 4, i64 6, i64 8, i64 0, i64 0, i64 2, i64 4, i64 6, i64 8, i64 3, i64 4, i64 0, i64 1, i64 2, i64 4, i64 6, i64 8], align 64
@__constant_11xindex = private constant [11 x i64] [i64 0, i64 5, i64 5, i64 10, i64 11, i64 16, i64 17, i64 22, i64 24, i64 30, i64 30], align 64
@__constant_30xf64 = private constant [30 x double] [double 0x401AEC5D63886595, double 0x4021D7C6327ED84D, double 0x4004C748E4755FFE, double 0x400A13FC86CEBBBA, double 0x4017F4CCEE5ABC0E, double 0x3FF35E75360D0247, double 0x400DF30BE0DED289, double 0x4018AC393682730C, double 0x401C98B439581062, double 0x3FF532B239A38FBD, double 0x40060AB8A5CE5B42, double 0x3FF2E8DFBD6A593A, double 0x40204474B838C112, double 0x3FF77CB81733226C, double 0x401F5FBFC6540CC8, double 3.310890e+00, double 0x40226751EFB6DCA0, double 0x40037DACEEE0F3CB, double 0x401871E9AF5BA2BE, double 0x401982C4D65E4606, double 0x400229C0229A5EBB, double 0x40239E2CDC011D36, double 0x40225A5D6BEBE165, double 0x401E261804D98394, double 8.130460e-01, double 0x400A3DCDF6987831, double 6.628280e+00, double 3.313540e+00, double 0x3FF71D2178F68BE3, double 6.519620e-01], align 64
