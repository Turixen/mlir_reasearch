...
@__constant_40xindex = private constant [40 x i64] [i64 0, i64 1, i64 3, i64 6, i64 7, i64 9, i64 0, i64 4, i64 6, i64 1, i64 2, i64 4, i64 7, i64 8, i64 0, i64 3, i64 6, i64 7, i64 9, i64 0, i64 2, i64 7, i64 9, i64 0, i64 4, i64 7, i64 0, i64 1, i64 3, i64 4, i64 6, i64 9, i64 6, i64 2, i64 4, i64 0, i64 3, i64 6, i64 8, i64 9], align 64
@__constant_11xindex = private constant [11 x i64] [i64 0, i64 6, i64 9, i64 14, i64 19, i64 23, i64 26, i64 32, i64 33, i64 35, i64 40], align 64
@__constant_40xf64 = private constant [40 x double] [double 0x401D6B78897E9963, double 0x401EF0E8858FF759, double 0x4010834DF04DDB55, double 0x400B123B3636F3B2, double 0x4013254A3C64345D, double 1.378080e-01, double 0x4020E0183F91E647, double 0x401CC0C308FEAC43, double 0x4015D3C74FB549F9, double 0x3FF942E87D2C7B89, double 5.096090e-01, double 0x40170D9988D2A1F9, double 0x40222C128BF3BEA9, double 0x3FF544955B4677B4, double 0x40176F5903A7546D, double 0x3FFC447A17F4128C, double 8.235340e+00, double 0x40164A9A8049667B, double 0x400409ABB01C92DE, double 0x4017F1094A2B9D3D, double 6.892990e+00, double 0x4012AC98E53EB39A, double 0x401B3BBC6EB0B7C3, double 0x400BECBF2B239A39, double 0x40108F1E8E608073, double 0x400C19641F644956, double 0x4014F7A67A52AC75, double 4.927440e+00, double 0x40102A8049667B5F, double 0x3FF974ABA3875925, double 0x4006AF81626B2F23, double 0x4005B07B784662BB, double 0x4021476D7625204B, double 0x400A1AB324851A87, double 7.862610e-01, double 0x400BDFD933E35C5B, double 0x401654C271FFF79D, double 0x40233F9830E3CD9A, double 0x402321B8ED1BF7AD, double 0x4006B21DDA059A74], align 64
@__constant_10x10xf64 = private constant [10 x [10 x double]] [[10 x double] [double 0x4023DF34AEAF5B9B, double 0x40206B1AA9296724, double 0x401B5FAB947AC46F, double 0x401775CCB2FA2D6E, double 0x401151FB6BFD3692, double 0x401A9EC83A2CB1C6, double 0x402001A87FC2794B, double 0x3FF6B4E7EA1A4440, double 0x401BF76019884BF5, double 0x400041835E80F218], [10 x double] [double 0x40215009C564EC85, double 0x4022041F653CE50B, double 0x4012462007920510, double 0x40035D80FCD293DA, double 0x4000AB5B429E3E62, double 0x3FE9D0A949926D50, double 0x40214C5F01AFB31A, double 0x4023687613962EA5, double 0x3FF0DB052BCB4208, double 0x40115386B252EE2C], [10 x double] [double 0x4016012648409D0B, double 0x401F6304757A7AC2, double 0x401DC0994B9E5BE7, double 0x401DBF3E1E0F4406, double 0x3FFA624BD87D9C04, double 0x402310EFAF1AB8E9, double 0x402186A473A73018, double 0x40133183A3A40AB2, double 0x4018BCBF8C4A2FFA, double 0x4018103CE01E321A], [10 x double] [double 0x400D94817DA16B08, double 0x401009059D3ACC5E, double 0x40145BD1D9E0BDAB, double 0x4023B6BA53C1ED11, double 0x4022D280DB46B908, double 0x4001BB03DA1CFBB5, double 0x400D8DDE9E272520, double 0x4008BB35AF1334B2, double 0x401EEB346614D2D3, double 0x40137275319C51F6], [10 x double] [double 0x401D40190D626C8E, double 0x40196AED5C8EB7CA, double 0x3FEE80FB973B9214, double 0x402264F01CD3DA42, double 0x40130E4EA50BCE1C, double 0x40177AB3A9AFA0E3, double 0x40161F7B2468AF35, double 0x40003CED8D917A13, double 0x400258F03F1A1778, double 0x3FFDBE7A3971B0C1], [10 x double] [double 0x401B1F16634C237C, double 0x400114B44DD4814B, double 0x4019C6999DE066B8, double 0x4012A22884079B37, double 0x40005238EEC3C54A, double 0x401466674246BD95, double 0x401E1B530931E86C, double 0x4000447B04C59067, double 0x4008C5618B4C44A2, double 0x4000744E2D2CB88E], [10 x double] [double 0x3FFBC5DCD8E4E260, double 0x4021524F55F9F816, double 0x401A8F9C374B78AB, double 0x3FFAB7387162CA4D, double 0x40205DDF52FF48C1, double 0x40135F222D56177F, double 0x40216655C24774F2, double 0x4011AEC20604C313, double 0x3FFBEA507DF8F452, double 0x3FE850E76DD431E6], [10 x double] [double 0x401DB1A864B898AA, double 0x40069FF0EFD0C0FA, double 0x3FEB8902A794B850, double 0x3FE596AB554B617E, double 0x3FF0C688D0F84D7A, double 0x4008E5AC5AC0DDB1, double 0x401B984CEBA411A6, double 0x3FFC3E4C88DF31E2, double 0x3FEEB2C27F0E9D0A, double 0x4021FE400B2A99B5], [10 x double] [double 0x4011FB13F8FE9C9F, double 0x3FDABD1D68B9D568, double 0x400747012731CBEF, double 0x4020CD57CB238E73, double 0x4008D544E1BE0E9C, double 0x4012348B40DAE8AE, double 0x3FEA2D493FFC9F8E, double 0x402330F07C3F816E, double 0x3FF3F09EC3CB4C5E, double 0x4020B3082D8F7892], [10 x double] [double 0x4018B2ADB7347CDC, double 0x401512C69430EEA0, double 0x4016B55736A1DD8F, double 0x401EA71EDAD15ACA, double 0x3FD5CE59AB991284, double 0x4019252CDC392F18, double 0x4006ECB8D99806D8, double 0x4020A954B546489F, double 0x401E8E8BDA49C164, double 0x4019B1D321C62EAF]], align 64
