...
@__constant_10x10xf64 = private constant [10 x [10 x double]] [[10 x double] [double 0x3FF3E5D53A79D50C, double 0x4021277BBBC8FDE2, double 0x400A05045DA2834C, double 0x4008C4FD7934562B, double 0x401476E485E05D26, double 0x401E2F34C0E90BB2, double 0x4017331AE3148867, double 0x4012708FF7E52F69, double 0x400502035CC46E0B, double 0x40019A0F87D17D41], [10 x double] [double 0x40007B3DECFCDA6A, double 0x4022CA273FB74152, double 0x40131B913911F838, double 0x401C86DE5480E5BE, double 0x3FF5860F6484B4DF, double 0x3FBC275218913400, double 0x400020C4C3D7B476, double 0x401BDF86F1DADDD8, double 0x3FE9A7ECF51DDAA0, double 0x3FE6ED8B767BF272], [10 x double] [double 0x4021C0031A46B664, double 0x4021AEA3CCFFF1BF, double 0x401B0304423CB1DF, double 0x4014D48641B3C49E, double 0x401A180DEB01EE3F, double 0x3FFF827595918339, double 0x4014BA9D8AF9121B, double 0x4012F462F17AD5F4, double 0x3FF18E2C976E8710, double 0x401D5135BBADADDF], [10 x double] [double 0x402247DDAC88692C, double 0x4003467453BF97A0, double 0x3FFD038C0763D068, double 0x3FFB01331B2C7468, double 0x4016D421B325B35E, double 0x3FDE6ED3DC880440, double 0x401B579F759DE8C4, double 0x40215F44DF8DAF5E, double 0x3FCEE539CDAD2900, double 0x4023FE44FB4556B0], [10 x double] [double 0x4011A2E14BDD296A, double 0x3FB5749A860F1A90, double 0x3FF1C0D659B3AD92, double 0x4017752479C42F7D, double 0x401781C5AE892AE0, double 0x4019668311906D18, double 0x400392E02DB84C83, double 0x401DBD383960DBD0, double 0x4017A94E29617038, double 0x3FE82EFAF72852F6], [10 x double] [double 0x40235F9D8863547F, double 0x4023D577E7B9A9A9, double 0x401C91170B5010B2, double 0x401E59AE148B1AEC, double 0x4023072F1C9550A1, double 0x4012ABD9768656F4, double 0x40106C86CEF8BD31, double 0x4006AD6E148E25B2, double 0x400970C53304A422, double 0x401C30566AF7EC37], [10 x double] [double 0x400A847D44A7BCD4, double 0x401E766EF667C9DE, double 0x4020A10BE38E3B3F, double 0x402031E5B383EFAC, double 0x4021D1DEF573F9D6, double 0x4023834D3FCD1430, double 0x4022C0EB3213BA78, double 0x4012BB8DF382050B, double 0x4017D62C77734338, double 0x40198772ECEEC32C], [10 x double] [double 0x4023B5DA15DABF88, double 0x3FFB117D6134371B, double 0x401713A29699812B, double 0x4015A89DB981374C, double 0x4011A4CF1B5A9687, double 0x40123B8C428EE73E, double 0x40184D8A2C1AE3E1, double 0x3FF827555D689722, double 0x401654759229A47E, double 0x4003959ABC08E3BC], [10 x double] [double 0x4020B53450F86F63, double 0x401E1A1824878E92, double 0x401FB7008C9231A2, double 0x4017CC65910CC4CB, double 0x4022B70942AEE480, double 0x401CE13D5F9160BA, double 0x3FDDB898C59FD86C, double 0x4019BDA23055FEC6, double 0x4013F7051D7379E2, double 0x40055293E38832EA], [10 x double] [double 0x3FD30628C35A1F90, double 0x40230E31AA0C8247, double 0x4016725DDB773FE1, double 0x40224B74B7F774B0, double 0x400B231349909A82, double 0x400C1693CAC94664, double 0x3FD9B9B588757054, double 0x401C2739BC50FA0A, double 0x401B33147DB82FBA, double 0x4004B3BF839370A2]], align 64
@__constant_35xindex = private constant [35 x i64] [i64 1, i64 7, i64 9, i64 1, i64 4, i64 6, i64 8, i64 1, i64 3, i64 6, i64 8, i64 2, i64 3, i64 8, i64 0, i64 3, i64 6, i64 8, i64 3, i64 5, i64 6, i64 9, i64 3, i64 4, i64 7, i64 9, i64 6, i64 7, i64 2, i64 3, i64 5, i64 7, i64 9, i64 4, i64 7], align 64
@__constant_11xindex = private constant [11 x i64] [i64 0, i64 3, i64 7, i64 11, i64 14, i64 18, i64 22, i64 26, i64 28, i64 33, i64 35], align 64
@__constant_35xf64 = private constant [35 x double] [double 0x4018A10A137F38C5, double 0x402295B2B346130A, double 0x400342B302F72B45, double 0x400869D388A8B08E, double 5.983930e-01, double 0x40157501E2584F4C, double 0x4023E4947064ECEA, double 0x4023A23C64345CFF, double 0x4019EE92923E5B85, double 0x3FF9D21DDA059A74, double 0x401E065300581494, double 0x40232ADD9C27E953, double 0x4012EA2163FDD65A, double 3.802050e-01, double 4.073990e-01, double 0x400B007A28BB0A2D, double 0x400B141D084E831B, double 9.869600e+00, double 0x40217E6D7A56DE33, double 0x401954C404A72EAE, double 0x40218959A30984E4, double 1.884490e-01, double 0x401FF52157689CA2, double 0x401E108FEAC42E99, double 0x4022FAD538AC18F8, double 0x401B46922D948DC1, double 0x40223F507E9D94D1, double 0x4011C6A6E32E3822, double 0x40158D6A9C560C7C, double 0x4018CE0F7FCFC3F8, double 0x401D29ECB31C219F, double 0x3FF8D8201CD5F99C, double 0x4007DBC23315D702, double 0x400938C7E28240B8, double 7.097560e-01], align 64
