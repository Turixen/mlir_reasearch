...
@__constant_10x10xf64 = private constant [10 x [10 x double]] [[10 x double] [double 0x4015092550A02336, double 0x4021B66B6BE371AF, double 0x3F55F1667ACCDC00, double 0x3FF20BCBA423E68B, double 0x40223E081D024E0F, double 0x40151646F6F57F02, double 0x40151BD9E4694D23, double 0x4009B124FA60DE88, double 0x40212B4F3A773597, double 0x400AEB0EB4E7A590], [10 x double] [double 0x4013DBDFDC589A89, double 0x3FFF7F202E316ECD, double 0x400D15FC3A7D229C, double 0x400ED66DA57C12EE, double 0x401173087C86813E, double 0x4011FE6B988912D3, double 0x3FE2B7B97917D8A4, double 0x3FFAD8DBC2670CAA, double 0x401D800B5243618A, double 0x401D38FB36268CD4], [10 x double] [double 0x401536C2EC08D0C7, double 0x402389ACD437F84F, double 0x3FD79BC57960975C, double 0x4019457AB5078517, double 0x3FE36E9452BAEC18, double 0x3FE9495A75047946, double 0x3FE1A229319DE136, double 0x3FDA37984C8877EC, double 0x3FDB11BDAF60DBE8, double 0x400E0D75FE84BA56], [10 x double] [double 0x4023C13EB78B7516, double 0x400BB847CBC972A2, double 0x4020590F70AE8CCA, double 0x3FF459D567403413, double 0x4021855F4D34F304, double 0x401647C9F0D54D41, double 0x3FDCE6EED794D5F8, double 0x40153979CC5ED07A, double 0x3FD511A56F5D2F24, double 0x400F58CF7B688C04], [10 x double] [double 0x4001760A5AD57CCB, double 0x400AD6016F3935B0, double 0x400927D1CEC5EBC7, double 0x4021C26F1A6D9EE4, double 0x3FE0DD508386F5E4, double 0x3FFD425ABCF60F79, double 0x4023A4852D3FA5D5, double 0x401E3F5FB980B571, double 0x402227114D933C25, double 0x4022114F1B115C5E], [10 x double] [double 0x402136EBFE3C56CF, double 0x3FBAA7AA128D7560, double 0x40146B24BFCFCE22, double 0x3FE089603B8024EE, double 0x4002524461273A1C, double 0x4022EC7FD7B14279, double 0x400E2E007142B08B, double 0x40002DAF6C7090C0, double 0x3FC27C605C7B1330, double 0x3FEBFE5D6E41B898], [10 x double] [double 0x401C938ED03AAFB4, double 0x3FEF72E617134CD4, double 0x401109E72FCB1713, double 0x3FEC2A462F6AC186, double 0x4013270F86EB4F00, double 0x3FBC0AE78172E130, double 0x401C7CB3BBD67AF2, double 0x402025074F4AAD14, double 0x4019C9FE126635CB, double 0x4016C24DC8FBEA6C], [10 x double] [double 0x3FE4634C2BBE65C4, double 0x4022D49833D5E626, double 0x40158DB1967B5F99, double 0x400126B8EC80FAE6, double 0x4010BB32AECA325B, double 0x4023E74A82B5AF58, double 0x4018F4C4D9B55640, double 0x40151C2297C4FD0D, double 0x401262E965715319, double 0x400B343DE50329E3], [10 x double] [double 0x40052083C8626DD6, double 0x401C980040704CFC, double 0x400CD10EEAA3B754, double 0x401D12B84B28439D, double 0x4021675F1DE4D5EC, double 0x4023BD3306BA3769, double 0x3FF2F3E64FEBDB6A, double 0x3FFE25F12C6E9432, double 0x4008AF4A79F84A68, double 0x40123ACA8DFBBF60], [10 x double] [double 0x3FDD0E995486CD10, double 0x40220EBFAA76A1B6, double 0x4006218DAE20D479, double 0x401E1CCE58625956, double 0x40188B59241F9830, double 0x3FFAB442441CEA9E, double 0x40161352940A13AF, double 0x4002594D6EDC6FB2, double 0x3FDAF7FEBF7D901C, double 0x3FF1A2813C4F2AE2]], align 64
@__constant_25xindex = private constant [25 x i64] [i64 0, i64 2, i64 4, i64 6, i64 8, i64 0, i64 2, i64 4, i64 6, i64 8, i64 0, i64 2, i64 4, i64 6, i64 8, i64 0, i64 2, i64 4, i64 6, i64 8, i64 0, i64 2, i64 4, i64 6, i64 8], align 64
@__constant_11xindex = private constant [11 x i64] [i64 0, i64 5, i64 5, i64 10, i64 10, i64 15, i64 15, i64 20, i64 20, i64 25, i64 25], align 64
@__constant_25xf64 = private constant [25 x double] [double 1.195600e+00, double 0x4018657DE0D66F0D, double 0x4015A0A84BE40421, double 0x40032E08F2170931, double 0x400024D76AB58080, double 0x40224B0531982880, double 0x4021F049A9973D9F, double 0x401F6F8F4730403A, double 0x40124AD7518B0D0F, double 6.239300e+00, double 0x4001C4ECE9A2C669, double 0x4011C30E7FF583A5, double 6.312230e-01, double 0x40036D666A98244F, double 0x400C2DC8754F3776, double 7.476510e+00, double 0x4016BCB4F1E4B44A, double 0x4013286013660E52, double 0x401778BA40D90E24, double 0x40109789613D31BA, double 0x4023F9A1B9F98B72, double 0x3FFD0FE79EE02A78, double 0x40229CDEA033E78E, double 9.586500e-01, double 0x401935D80E496EDF], align 64
