...
@__constant_10x10xf64 = private constant [10 x [10 x double]] [[10 x double] [double 0x3FFA9A5DBDE563DC, double 0x4020786F48A3DC40, double 0x3FF782701C067B62, double 0x40177F87FE84A393, double 0x40116C245F1CB72C, double 0x4001830AC8E7C1E4, double 0x4021661C132B3EE5, double 0x3FE0DC8AC3E1EE6C, double 0x4023137FFC91D256, double 0x4019731792CAF201], [10 x double] [double 0x40124005ECC9F2C8, double 0x4012380276A9965E, double 0x3FF4E5287740A913, double 0x3FF53752769C3C8A, double 0x3FE451B8E6782346, double 0x3FEB94C8D0929138, double 0x40150F9A2688169A, double 0x4020E274322420F5, double 0x40239267207D3806, double 0x400F22B0A07CBD42], [10 x double] [double 0x3FE2577222C59ABA, double 0x4004633BDE86CB3C, double 0x3FEEE7110E5E6FA8, double 0x3FF6D7D1BD233A52, double 0x402222B6EE836A93, double 0x400DF231926B028E, double 0x3FF02E3B476E09A4, double 0x402291697F660994, double 0x4007C9D99D4AD0CA, double 0x3F86FBDDA6E54480], [10 x double] [double 0x40080E09ADB18848, double 0x4012411AA8182AC4, double 0x401A8FFC9DF4DA19, double 0x3FC635BCB870E4D0, double 0x4002843713DBDE91, double 0x4022A32F7A82DF42, double 0x401041858C9E571A, double 0x400ECF23667C03F4, double 0x4020BFEA5369308F, double 0x400DEC5EA46BA4F6], [10 x double] [double 0x4018E05002BEAB40, double 0x401486E0980E3220, double 0x401C0BD50E0274B0, double 0x40076A15542678CE, double 0x3FE8BFFF59FEDE32, double 0x3FE9A83FB1464846, double 0x3FF665AD8A6EE638, double 0x402151A9E857C247, double 0x4018C77C2FD6C565, double 0x400F702D4B3BA8FA], [10 x double] [double 0x4005D3A53D9FED22, double 0x400AA850861A9910, double 0x3FFA9481BD1B1F78, double 0x40076FB177FB7D0E, double 0x3FEE26F2DAD74BAC, double 0x3FB9AAA335CBD300, double 0x40133113AC345D0E, double 0x401B3408753C67EC, double 0x3FFC7E10186F870F, double 0x4020D26BBB13834F], [10 x double] [double 0x401DA74D0AEC6310, double 0x401DE0359080CBEE, double 0x40119DA1945FB962, double 0x3F9F24875C17CB00, double 0x401CA6AFD6017EDC, double 0x401FE353A44F9658, double 0x40029C2821C3FDBC, double 0x401293B9C77A3C4E, double 0x3FE3F081902310CA, double 0x4013269E3D264F70], [10 x double] [double 0x3FE027CB5A796DF2, double 0x401474A191A55700, double 0x3FBC2D7D57837E30, double 0x4012BF8AF0955C9E, double 0x401C5E9D29652986, double 0x4021769401156C53, double 0x401FFBAF53E989FE, double 0x4023A36588D0DFC4, double 0x3FD61098ABF463EC, double 0x4013386242B30A71], [10 x double] [double 0x40191D89A00AC539, double 0x4015FB98792B3A28, double 0x40104229870773F4, double 0x3FFEAA012ECF8909, double 0x3FF735669A64ADFA, double 0x400D3D11E3955720, double 0x400FF547920EFF32, double 0x3FF03FC5999255E6, double 0x401E9269C8298AFA, double 0x4018A5F656115930], [10 x double] [double 0x40212589013E6784, double 0x401CE7BA0A8F7A5F, double 0x401AA286157D4823, double 0x3FF362A2BE97199B, double 0x401BD3F97A38C40E, double 0x4020656AE47EB330, double 0x401AAC28B6E3AC88, double 0x400A6D57CC07685A, double 0x40123BBEAFB4A147, double 0x4015D1FD6071F18F]], align 64
@__constant_50xindex = private constant [50 x i64] [i64 0, i64 1, i64 3, i64 4, i64 6, i64 9, i64 3, i64 7, i64 9, i64 0, i64 1, i64 2, i64 6, i64 8, i64 0, i64 1, i64 3, i64 6, i64 7, i64 9, i64 0, i64 1, i64 2, i64 5, i64 8, i64 3, i64 8, i64 9, i64 0, i64 2, i64 3, i64 4, i64 6, i64 8, i64 9, i64 5, i64 6, i64 7, i64 8, i64 4, i64 5, i64 6, i64 7, i64 8, i64 9, i64 0, i64 3, i64 4, i64 6, i64 9], align 64
@__constant_11xindex = private constant [11 x i64] [i64 0, i64 6, i64 9, i64 14, i64 20, i64 25, i64 28, i64 35, i64 39, i64 45, i64 50], align 64
@__constant_50xf64 = private constant [50 x double] [double 0x40214B3C81908E58, double 0x401CBBA55D1C3AC9, double 0x3FB54185058DDE7A, double 0x4017E70A3D70A3D7, double 0x4006E2F48C2E770C, double 0x4003784EC636B096, double 0x40125E0BD44998D0, double 0x401908FCD67FD3F6, double 0x4022F55D5F56A7AD, double 8.044010e-01, double 0x4017E1904B3C3E75, double 0x3FB7D9988D2A1F8E, double 0x3FB32873BC903EA7, double 2.779260e-01, double 3.881050e+00, double 0x40232D5BEE3D5FDD, double 0x40208475818C5C9A, double 0x4016B805A2D72FFD, double 0x3FEB13708AAC96CC, double 0x4018F35E310DBF05, double 0x400E92E59AF9EBEA, double 0x400AB2C7325918A0, double 0x4006CEC0F88333FD, double 0x401F56BF01322F27, double 0x3FF45CA9EF5232D3, double 0x3FF677E0AC7DA1EC, double 0x4001B1B584B1AB08, double 0x401D0B7D84901D19, double 0x3FF1DAE70C1333B9, double 7.838160e+00, double 0x4015BDE0D66F0CFE, double 0x4000998958D9B5E9, double 0x401931FAB96F21F7, double 3.917590e-01, double 0x400CB2CCF6BE37DF, double 0x3FFB26AFCCE1C582, double 0x4012E9B38D60A633, double 0x4008F1361DC93EA3, double 4.145790e+00, double 0x40224C37A3DB3BFB, double 0x40023BE4473CD573, double 0x400DFAD5BEE3D5FE, double 0x3FF4A3315D701D9F, double 0x40237CAFD5454153, double 0x400FB08893B7D849, double 0x40200C1CA3A4B557, double 0x4023559817B95A29, double 0x402199FC08FA7A85, double 0x3FF967C393682731, double 8.917440e-01], align 64
