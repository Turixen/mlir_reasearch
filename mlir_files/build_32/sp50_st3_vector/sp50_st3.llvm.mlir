module {
  ...
  llvm.mlir.global private constant @__constant_10x10xf64(dense<[[1.6626870553793571, 8.2352240276360362, 1.4693451971758908, 5.8745422142464063, 4.3556074963833389, 2.1889854140974752, 8.6994329443254603, 0.52692163713750295, 9.5380858352665818, 6.3623946129196165], [4.5625226019153118, 4.5546968976028364, 1.3059467943481351, 1.3260063775267406, 0.63497586263211114, 0.86191216217824884, 5.2652364750444125, 8.4422927540876831, 9.7859430458884269, 3.8919384515826616], [0.57317454139123147, 2.5484540352712468, 0.96570637518333501, 1.4276902568996275, 9.0678019080562873, 3.7432586134821753, 1.0112870016315378, 9.2840080081994429, 2.9735595978218941, 0.011222583442448419], [3.00685439775501, 4.5635782494306945, 6.6406120949455039, 0.17351492887409004, 2.3145581771348778, 9.3187216076618178, 4.0639860126155103, 3.8511417395206937, 8.3748346391587614, 3.740414890799566], [6.2190552166819657, 5.1317161329903058, 7.0115549267767818, 2.9267984937897387, 0.77343719079266848, 0.80178818344052938, 1.3998237044855966, 8.6594994170310553, 6.1948096728168354, 3.9297738912183577], [2.7283425154142984, 3.3321848370425258, 1.6612565409613733, 2.9295377133963774, 0.94225447409040929, 0.10025997222312455, 4.7979266077957288, 6.8008135145300734, 1.7807770685689694, 8.4109781705207336], [7.4133798319605972, 7.4689543322192389, 4.4039366897035013, 0.030412783618838368, 7.162780135957032, 7.971998755796072, 2.3262484205185654, 4.6442633789402645, 0.62310865546944538, 4.7877130083687547], [0.50485770865219437, 5.1138975865521843, 0.11006911646426754, 4.687053450695343, 7.0923963993067272, 8.7315979326869293, 7.9957860099116242, 9.8191340212796447, 0.3447629622692705, 4.8050623342302154], [6.2788453108381015, 5.4956988270410321, 4.0646115396784701, 1.9165050343077061, 1.4505373030650603, 3.654819276804929, 3.9947654162241628, 1.0155693053142101, 7.6429816508632431, 6.1620725105370155], [8.573310889117927, 7.2262956285545377, 6.6587146146503384, 1.2115809864932092, 6.957006368365013, 8.1980811504996325, 6.6681240631543304, 3.3033901157150867, 4.5583445981977269, 5.4550681180520675]]> : tensor<10x10xf64>) {addr_space = 0 : i32, alignment = 64 : i64} : !llvm.array<10 x array<10 x f64>>
  llvm.mlir.global private constant @__constant_50xindex(dense<[0, 1, 3, 4, 6, 9, 3, 7, 9, 0, 1, 2, 6, 8, 0, 1, 3, 6, 7, 9, 0, 1, 2, 5, 8, 3, 8, 9, 0, 2, 3, 4, 6, 8, 9, 5, 6, 7, 8, 4, 5, 6, 7, 8, 9, 0, 3, 4, 6, 9]> : tensor<50xindex>) {addr_space = 0 : i32, alignment = 64 : i64} : !llvm.array<50 x i64>
  llvm.mlir.global private constant @__constant_11xindex(dense<[0, 6, 9, 14, 20, 25, 28, 35, 39, 45, 50]> : tensor<11xindex>) {addr_space = 0 : i32, alignment = 64 : i64} : !llvm.array<11 x i64>
  llvm.mlir.global private constant @__constant_50xf64(dense<[8.6469459999999998, 7.1832479999999999, 0.083030999999999993, 5.975625, 2.8608180000000001, 2.4337439999999999, 4.5918419999999998, 6.2587770000000003, 9.4792280000000008, 8.044010e-01, 5.9702770000000003, 0.093163999999999996, 0.074836, 2.779260e-01, 3.881050e+00, 9.5885920000000002, 8.2587089999999996, 5.6797089999999999, 0.84612299999999995, 6.2376639999999997, 3.8217270000000001, 3.337294, 2.8509540000000002, 7.8347129999999998, 1.2726230000000001, 1.4042669999999999, 2.2117719999999998, 7.2612209999999999, 1.1159429999999999, 7.838160e+00, 5.4354279999999999, 2.0749689999999998, 6.2988080000000002, 3.917590e-01, 3.5873050000000002, 1.6969449999999999, 4.728224, 3.1177790000000001, 4.145790e+00, 9.1488619999999994, 2.2792439999999998, 3.7474780000000001, 1.2898419999999999, 9.7435290000000005, 3.961198, 8.0236560000000008, 9.6671759999999995, 8.800751, 1.587833, 8.917440e-01]> : tensor<50xf64>) {addr_space = 0 : i32, alignment = 64 : i64} : !llvm.array<50 x f64>
  ...
  llvm.func @assemble_sparse() -> !llvm.struct<(struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)>, struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)>, struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)>, struct<(array<2 x i64>, array<3 x i64>)>)> {
    %0 = llvm.mlir.addressof @__constant_50xindex : !llvm.ptr
    ...
    %15 = llvm.getelementptr %6[0, 0] : (!llvm.ptr) -> !llvm.ptr, !llvm.array<50 x f64>
    ...
    %29 = llvm.getelementptr %0[0, 0] : (!llvm.ptr) -> !llvm.ptr, !llvm.array<50 x i64>
