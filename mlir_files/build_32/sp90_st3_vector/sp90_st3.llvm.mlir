module {
  ...
  llvm.mlir.global private constant @__constant_9xindex(dense<[0, 6, 0, 9, 0, 3, 3, 6, 9]> : tensor<9xindex>) {addr_space = 0 : i32, alignment = 64 : i64} : !llvm.array<9 x i64>
  llvm.mlir.global private constant @__constant_11xindex(dense<[0, 2, 2, 2, 4, 4, 4, 6, 6, 6, 9]> : tensor<11xindex>) {addr_space = 0 : i32, alignment = 64 : i64} : !llvm.array<11 x i64>
  llvm.mlir.global private constant @__constant_9xf64(dense<[2.3730959999999999, 7.281612, 3.449948, 5.6092490000000002, 1.1728240000000001, 2.3153280000000001, 2.313010e+00, 3.0813280000000001, 5.195017]> : tensor<9xf64>) {addr_space = 0 : i32, alignment = 64 : i64} : !llvm.array<9 x f64>
  llvm.mlir.global private constant @__constant_10x10xf64(dense<[[2.8868831766030723, 3.4696937995146717, 5.2537520176178001, 9.5330554725193863, 7.4399141021817705, 8.3300884511162074, 1.3681451186700122, 6.9951605249060664, 2.42725085160831, 5.8343970574929767], [5.9061457027728546, 2.3661588344989406, 9.9244033550520214, 5.3751879577075625, 7.080611625228892, 3.2248486239247653, 8.4924065965543001, 1.2165794220441195, 6.1606426969618031, 9.563453527671923], [4.9242010297015781, 5.0241383523720895, 8.5183202895833218, 9.5760534593756947, 8.2411924574192632, 2.0594818438954041, 8.1909323236486955, 3.6701845029765789, 5.5577331960213279, 7.864040407280017], [3.2595444212062463, 5.466194725279399, 8.8640319882264009, 3.1171664310977421, 0.1693161794728304, 0.8235165498360264, 3.767634659327399, 3.4760829439335108, 1.543597066914042, 7.3398269798942373], [4.0494497202432997, 4.6384145549643101, 5.5194063145577683, 1.9593106343852118, 4.5362324262401632, 2.4634440136956535, 1.1448145538775167, 4.431812631850816, 5.3285174073905139, 5.1328870383093337], [9.1800870025067525, 9.307267669851937, 5.9518390176424383, 9.9162734597101778, 8.5896537940389184, 9.3361848434651176, 1.0567732943106034, 9.9227688347756775, 3.4820661564373454, 2.4138740530179579], [8.5853720003852469, 6.9587879386454441, 0.48890684428048448, 2.325006266674936, 4.5556715430551957, 2.6950670270802624, 0.36266226539088064, 9.5472525133221726, 6.8880143797650453, 6.9179034342328807], [9.2980953060137441, 7.0233237895715988, 0.22201719776894668, 3.5542713205251761, 3.9009350705300205, 0.72042222390660382, 8.2182346612605635, 1.3869013208579595, 7.9660708327702121, 8.5624415288337339], [1.1346638673650944, 8.413732562533113, 4.1704109805367171, 5.015206176915413, 1.2850408383854783, 5.0421895767265159, 9.2604939170377172, 9.6095455083131291, 3.1416819206883364, 1.3371246613306964], [1.2347117356619974, 3.4404808736488657, 1.8686711443334025, 9.2166016432134317, 6.1508774913407347, 1.2976172335895797, 3.3922226582134507, 2.204598486703182, 9.6014046468217344, 4.0628977338708259]]> : tensor<10x10xf64>) {addr_space = 0 : i32, alignment = 64 : i64} : !llvm.array<10 x array<10 x f64>>
