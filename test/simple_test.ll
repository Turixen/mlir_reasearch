...
@__constant_2x2xf64 = private constant [2 x [2 x double]] [[2 x double] [double 1.000000e+00, double 1.000000e+00], [2 x double] [double 1.000000e+00, double 1.000000e+00]], align 64
@__constant_3xindex = private constant [3 x i64] [i64 0, i64 1, i64 2], align 64
@__constant_2xindex = private constant [2 x i64] [i64 0, i64 1], align 64
@__constant_2xf64 = private constant [2 x double] [double 1.000000e+00, double 2.000000e+00], align 64
...
define i32 @main() {
  %1 = call ptr @malloc(i64 add (i64 ptrtoint (ptr getelementptr (double, ptr null, i32 4) to i64), i64 64))
...
define { { ptr, ptr, i64, [1 x i64], [1 x i64] }, { ptr, ptr, i64, [1 x i64], [1 x i64] }, { ptr, ptr, i64, [1 x i64], [1 x i64] }, { [2 x i64], [3 x i64] } } @assemble_sparse_tensor() {
  %1 = load i64, ptr getelementptr (i64, ptr @__constant_3xindex, i64 2), align 4
  %2 = insertvalue { [2 x i64], [3 x i64] } { [2 x i64] [i64 2, i64 2], [3 x i64] [i64 3, i64 0, i64 0] }, i64 %1, 1, 1
  %3 = insertvalue { [2 x i64], [3 x i64] } %2, i64 %1, 1, 2
  %4 = insertvalue { { ptr, ptr, i64, [1 x i64], [1 x i64] }, { ptr, ptr, i64, [1 x i64], [1 x i64] }, { ptr, ptr, i64, [1 x i64], [1 x i64] }, { [2 x i64], [3 x i64] } } { { ptr, ptr, i64, [1 x i64], [1 x i64] } { ptr inttoptr (i64 3735928559 to ptr), ptr @__constant_3xindex, i64 0, [1 x i64] [i64 3], [1 x i64] [i64 1] }, { ptr, ptr, i64, [1 x i64], [1 x i64] } { ptr inttoptr (i64 3735928559 to ptr), ptr @__constant_2xindex, i64 0, [1 x i64] [i64 2], [1 x i64] [i64 1] }, { ptr, ptr, i64, [1 x i64], [1 x i64] } { ptr inttoptr (i64 3735928559 to ptr), ptr @__constant_2xf64, i64 0, [1 x i64] [i64 2], [1 x i64] [i64 1] }, { [2 x i64], [3 x i64] } undef }, { [2 x i64], [3 x i64] } %3, 3
