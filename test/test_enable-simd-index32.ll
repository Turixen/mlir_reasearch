...
75:                                               ; preds = %72
  ...
  %80 = extractvalue { ptr, ptr, i64, [2 x i64], [2 x i64] } %59, 1
  %81 = mul i64 %77, 3
  %82 = add i64 %81, 0
  %83 = getelementptr double, ptr %80, i64 %82
  %84 = call <4 x double> @llvm.masked.load.v4f64.p0(ptr %83, i32 8, <4 x i1> <i1 true, i1 true, i1 true, i1 false>, <4 x double> zeroinitializer)
  %85 = insertelement <4 x double> undef, double %79, i32 0
  %86 = shufflevector <4 x double> %85, <4 x double> undef, <4 x i32> zeroinitializer
  %87 = extractvalue { ptr, ptr, i64, [2 x i64], [2 x i64] } %37, 1
  %88 = mul i64 %64, 3
  %89 = add i64 %88, 0
  %90 = getelementptr double, ptr %87, i64 %89
  %91 = call <4 x double> @llvm.masked.load.v4f64.p0(ptr %90, i32 8, <4 x i1> <i1 true, i1 true, i1 true, i1 false>, <4 x double> zeroinitializer)
  %92 = fmul <4 x double> %86, %91
  %93 = fadd <4 x double> %84, %92
  %94 = extractvalue { ptr, ptr, i64, [2 x i64], [2 x i64] } %59, 1
  %95 = mul i64 %77, 3
  %96 = add i64 %95, 0
  %97 = getelementptr double, ptr %94, i64 %96
  call void @llvm.masked.store.v4f64.p0(<4 x double> %93, ptr %97, i32 8, <4 x i1> <i1 true, i1 true, i1 true, i1 false>)
  %98 = add i64 %73, 1
  br label %72
