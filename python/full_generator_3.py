...
#CSR = #sparse_tensor.encoding<{{ map = (d0, d1) -> (d0: compressed, d1: dense) }}>
...
func.func @sparse_dense_matmul(
    ...
    %res = linalg.matmul ins(%sparse, %dense) outs(%init)
...
func.func private @assemble_sparse() -> tensor<{m}x{k}xf64, #CSR> {{
